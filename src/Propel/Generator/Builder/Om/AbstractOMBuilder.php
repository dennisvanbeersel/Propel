...
", $namespace, $class, $alias);
    ...
    /**
     * Emits the standard class-level phpDoc block used by every "stub"-style
     * builder (extension/inheritance) — a one-line description, an optional
     * timestamp, and the boilerplate "you should add additional methods" footer.
     *
     * Skips emission entirely when `generator.objectModel.addClassLevelComment`
     * is disabled.
     *
     * @param string $script
     * @param string $description Short, single-line description of the class
     *                            (e.g. "Skeleton subclass for representing a row from the 'book' table.").
     *
     * @return void
     */
    protected function addClassLevelComment(string &$script, string $description): void
    {
