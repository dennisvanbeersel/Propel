...
/**
 * Concrete: `CachingConnection(PdoConnection(SQLite))` MUST conform to
 * the {@see ConnectionInterface} contract.
 */
class CachingConnectionContractTest extends ConnectionInterfaceContractTestCase
{
    /**
    ...
    {
        return new CachingConnection(new PdoConnection('sqlite::memory:'));
    }
}
