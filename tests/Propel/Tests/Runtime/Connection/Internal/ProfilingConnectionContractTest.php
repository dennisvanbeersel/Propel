...
/**
 * Concrete: `ProfilingConnection(PdoConnection(SQLite))` MUST conform to
 * the {@see ConnectionInterface} contract.
 */
class ProfilingConnectionContractTest extends ConnectionInterfaceContractTestCase
{
    /**
    ...
    {
        return new ProfilingConnection(new PdoConnection('sqlite::memory:'));
    }
}
