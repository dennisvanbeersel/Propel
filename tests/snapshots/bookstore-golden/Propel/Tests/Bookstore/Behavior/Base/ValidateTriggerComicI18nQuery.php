 ...
 *
 * @method     ChildValidateTriggerComicI18nQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildValidateTriggerComicI18nQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildValidateTriggerComicI18nQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 ...
 *
 * @method     ChildValidateTriggerComicI18nQuery joinWithValidateTriggerComic($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the ValidateTriggerComic relation
 *
 * @method     ChildValidateTriggerComicI18nQuery leftJoinWithValidateTriggerComic() Adds a LEFT JOIN clause and with to the query using the ValidateTriggerComic relation
 * @method     ChildValidateTriggerComicI18nQuery rightJoinWithValidateTriggerComic() Adds a RIGHT JOIN clause and with to the query using the ValidateTriggerComic relation
 * @method     ChildValidateTriggerComicI18nQuery innerJoinWithValidateTriggerComic() Adds a INNER JOIN clause and with to the query using the ValidateTriggerComic relation
 *
 ...
 *
 * @method     ChildValidateTriggerComicI18n|null findOne(?ConnectionInterface $con = null) Return the first ChildValidateTriggerComicI18n matching the query
 ...
 *
 * @method     ChildValidateTriggerComicI18n|null findOneById(int $id) Return the first ChildValidateTriggerComicI18n filtered by the id column
 * @method     ChildValidateTriggerComicI18n|null findOneByLocale(string $locale) Return the first ChildValidateTriggerComicI18n filtered by the locale column
 * @method     ChildValidateTriggerComicI18n|null findOneByTitle(string $title) Return the first ChildValidateTriggerComicI18n filtered by the title column
 *
 * @method     ChildValidateTriggerComicI18n requirePk($key, ?ConnectionInterface $con = null) Return the ChildValidateTriggerComicI18n by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildValidateTriggerComicI18n requireOne(?ConnectionInterface $con = null) Return the first ChildValidateTriggerComicI18n matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildValidateTriggerComicI18n requireOneById(int $id) Return the first ChildValidateTriggerComicI18n filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildValidateTriggerComicI18n requireOneByLocale(string $locale) Return the first ChildValidateTriggerComicI18n filtered by the locale column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildValidateTriggerComicI18n requireOneByTitle(string $title) Return the first ChildValidateTriggerComicI18n filtered by the title column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildValidateTriggerComicI18n[]|Collection find(?ConnectionInterface $con = null) Return ChildValidateTriggerComicI18n objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildValidateTriggerComicI18n> find(?ConnectionInterface $con = null) Return ChildValidateTriggerComicI18n objects based on current ModelCriteria
 *
 * @method     ChildValidateTriggerComicI18n[]|Collection findById(int|array<int> $id) Return ChildValidateTriggerComicI18n objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildValidateTriggerComicI18n> findById(int|array<int> $id) Return ChildValidateTriggerComicI18n objects filtered by the id column
 * @method     ChildValidateTriggerComicI18n[]|Collection findByLocale(string|array<string> $locale) Return ChildValidateTriggerComicI18n objects filtered by the locale column
 * @psalm-method Collection&\Traversable<ChildValidateTriggerComicI18n> findByLocale(string|array<string> $locale) Return ChildValidateTriggerComicI18n objects filtered by the locale column
 * @method     ChildValidateTriggerComicI18n[]|Collection findByTitle(string|array<string> $title) Return ChildValidateTriggerComicI18n objects filtered by the title column
 * @psalm-method Collection&\Traversable<ChildValidateTriggerComicI18n> findByTitle(string|array<string> $title) Return ChildValidateTriggerComicI18n objects filtered by the title column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildValidateTriggerComicI18n> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class ValidateTriggerComicI18nQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore-behavior', $modelName = '\\Propel\\Tests\\Bookstore\\Behavior\\ValidateTriggerComicI18n', ?string $modelAlias = null)
    {
    ...
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = ValidateTriggerComicI18nTableMap::getInstanceFromPool(serialize([(null === $key[0] || is_scalar($key[0]) || is_callable([$key[0], '__toString']) ? (string) $key[0] : $key[0]), (null === $key[1] || is_scalar($key[1]) || is_callable([$key[1], '__toString']) ? (string) $key[1] : $key[1])]))))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            ValidateTriggerComicI18nTableMap::addInstanceToPool($obj, serialize([(null === $key[0] || is_scalar($key[0]) || is_callable([$key[0], '__toString']) ? (string) $key[0] : $key[0]), (null === $key[1] || is_scalar($key[1]) || is_callable([$key[1], '__toString']) ? (string) $key[1] : $key[1])]));
        }
        $stmt->closeCursor();
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ValidateTriggerComicI18nTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByLocale($locale = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ValidateTriggerComicI18nTableMap::COL_LOCALE, $locale, $comparison);
    ...
    public function filterByTitle($title = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ValidateTriggerComicI18nTableMap::COL_TITLE, $title, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinValidateTriggerComic(?string $relationAlias = null, ?string $joinType = 'LEFT JOIN')
    {
     ...
     */
    public function useValidateTriggerComicQuery(?string $relationAlias = null, string $joinType = 'LEFT JOIN')
    {
        return $this
