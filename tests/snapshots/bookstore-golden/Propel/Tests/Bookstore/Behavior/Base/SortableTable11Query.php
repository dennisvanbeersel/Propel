 ...
 *
 * @method     ChildSortableTable11Query leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildSortableTable11Query rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildSortableTable11Query innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 * @method     ChildSortableTable11|null findOne(?ConnectionInterface $con = null) Return the first ChildSortableTable11 matching the query
 ...
 *
 * @method     ChildSortableTable11|null findOneById(int $id) Return the first ChildSortableTable11 filtered by the id column
 * @method     ChildSortableTable11|null findOneByTitle(string $title) Return the first ChildSortableTable11 filtered by the title column
 * @method     ChildSortableTable11|null findOneBySortableRank(int $sortable_rank) Return the first ChildSortableTable11 filtered by the sortable_rank column
 *
 * @method     ChildSortableTable11 requirePk($key, ?ConnectionInterface $con = null) Return the ChildSortableTable11 by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSortableTable11 requireOne(?ConnectionInterface $con = null) Return the first ChildSortableTable11 matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildSortableTable11 requireOneById(int $id) Return the first ChildSortableTable11 filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSortableTable11 requireOneByTitle(string $title) Return the first ChildSortableTable11 filtered by the title column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSortableTable11 requireOneBySortableRank(int $sortable_rank) Return the first ChildSortableTable11 filtered by the sortable_rank column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildSortableTable11[]|Collection find(?ConnectionInterface $con = null) Return ChildSortableTable11 objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSortableTable11> find(?ConnectionInterface $con = null) Return ChildSortableTable11 objects based on current ModelCriteria
 *
 * @method     ChildSortableTable11[]|Collection findById(int|array<int> $id) Return ChildSortableTable11 objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildSortableTable11> findById(int|array<int> $id) Return ChildSortableTable11 objects filtered by the id column
 * @method     ChildSortableTable11[]|Collection findByTitle(string|array<string> $title) Return ChildSortableTable11 objects filtered by the title column
 * @psalm-method Collection&\Traversable<ChildSortableTable11> findByTitle(string|array<string> $title) Return ChildSortableTable11 objects filtered by the title column
 * @method     ChildSortableTable11[]|Collection findBySortableRank(int|array<int> $sortable_rank) Return ChildSortableTable11 objects filtered by the sortable_rank column
 * @psalm-method Collection&\Traversable<ChildSortableTable11> findBySortableRank(int|array<int> $sortable_rank) Return ChildSortableTable11 objects filtered by the sortable_rank column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildSortableTable11> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class SortableTable11Query extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore-behavior', $modelName = '\\Propel\\Tests\\Bookstore\\Behavior\\SortableTable11', ?string $modelAlias = null)
    {
    ...
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SortableTable11TableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SortableTable11TableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SortableTable11TableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SortableTable11TableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SortableTable11TableMap::COL_ID, $id, $comparison);
    ...
    public function filterByTitle($title = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SortableTable11TableMap::COL_TITLE, $title, $comparison);
    ...
    public function filterBySortableRank($sortableRank = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SortableTable11TableMap::COL_SORTABLE_RANK, $sortableRank, $comparison);
    ...
    public function orderByRank(string $order = Criteria::ASC)
    {
        ...
        switch ($order) {
            case Criteria::ASC:
                $this->addAscendingOrderByColumn($this->getAliasedColName(SortableTable11TableMap::RANK_COL));

                return $this;
            case Criteria::DESC:
                $this->addDescendingOrderByColumn($this->getAliasedColName(SortableTable11TableMap::RANK_COL));
