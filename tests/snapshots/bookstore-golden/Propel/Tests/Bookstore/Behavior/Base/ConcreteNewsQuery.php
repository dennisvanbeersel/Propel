 ...
 *
 * @method     ChildConcreteNewsQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildConcreteNewsQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildConcreteNewsQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 ...
 *
 * @method     ChildConcreteNewsQuery joinWithConcreteArticle($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the ConcreteArticle relation
 *
 * @method     ChildConcreteNewsQuery leftJoinWithConcreteArticle() Adds a LEFT JOIN clause and with to the query using the ConcreteArticle relation
 * @method     ChildConcreteNewsQuery rightJoinWithConcreteArticle() Adds a RIGHT JOIN clause and with to the query using the ConcreteArticle relation
 * @method     ChildConcreteNewsQuery innerJoinWithConcreteArticle() Adds a INNER JOIN clause and with to the query using the ConcreteArticle relation
 *
 ...
 *
 * @method     ChildConcreteNewsQuery joinWithConcreteAuthor($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the ConcreteAuthor relation
 *
 * @method     ChildConcreteNewsQuery leftJoinWithConcreteAuthor() Adds a LEFT JOIN clause and with to the query using the ConcreteAuthor relation
 * @method     ChildConcreteNewsQuery rightJoinWithConcreteAuthor() Adds a RIGHT JOIN clause and with to the query using the ConcreteAuthor relation
 * @method     ChildConcreteNewsQuery innerJoinWithConcreteAuthor() Adds a INNER JOIN clause and with to the query using the ConcreteAuthor relation
 *
 ...
 *
 * @method     ChildConcreteNewsQuery joinWithConcreteContent($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the ConcreteContent relation
 *
 * @method     ChildConcreteNewsQuery leftJoinWithConcreteContent() Adds a LEFT JOIN clause and with to the query using the ConcreteContent relation
 * @method     ChildConcreteNewsQuery rightJoinWithConcreteContent() Adds a RIGHT JOIN clause and with to the query using the ConcreteContent relation
 * @method     ChildConcreteNewsQuery innerJoinWithConcreteContent() Adds a INNER JOIN clause and with to the query using the ConcreteContent relation
 *
 ...
 *
 * @method     ChildConcreteNewsQuery joinWithConcreteCategory($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the ConcreteCategory relation
 *
 * @method     ChildConcreteNewsQuery leftJoinWithConcreteCategory() Adds a LEFT JOIN clause and with to the query using the ConcreteCategory relation
 * @method     ChildConcreteNewsQuery rightJoinWithConcreteCategory() Adds a RIGHT JOIN clause and with to the query using the ConcreteCategory relation
 * @method     ChildConcreteNewsQuery innerJoinWithConcreteCategory() Adds a INNER JOIN clause and with to the query using the ConcreteCategory relation
 *
 ...
 *
 * @method     ChildConcreteNews|null findOne(?ConnectionInterface $con = null) Return the first ChildConcreteNews matching the query
 ...
 *
 * @method     ChildConcreteNews|null findOneByBody(string $body) Return the first ChildConcreteNews filtered by the body column
 * @method     ChildConcreteNews|null findOneByAuthorId(int $author_id) Return the first ChildConcreteNews filtered by the author_id column
 * @method     ChildConcreteNews|null findOneById(int $id) Return the first ChildConcreteNews filtered by the id column
 * @method     ChildConcreteNews|null findOneByTitle(string $title) Return the first ChildConcreteNews filtered by the title column
 * @method     ChildConcreteNews|null findOneByCategoryId(int $category_id) Return the first ChildConcreteNews filtered by the category_id column
 *
 * @method     ChildConcreteNews requirePk($key, ?ConnectionInterface $con = null) Return the ChildConcreteNews by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildConcreteNews requireOne(?ConnectionInterface $con = null) Return the first ChildConcreteNews matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildConcreteNews requireOneByBody(string $body) Return the first ChildConcreteNews filtered by the body column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildConcreteNews requireOneByAuthorId(int $author_id) Return the first ChildConcreteNews filtered by the author_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildConcreteNews requireOneById(int $id) Return the first ChildConcreteNews filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildConcreteNews requireOneByTitle(string $title) Return the first ChildConcreteNews filtered by the title column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildConcreteNews requireOneByCategoryId(int $category_id) Return the first ChildConcreteNews filtered by the category_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildConcreteNews[]|Collection find(?ConnectionInterface $con = null) Return ChildConcreteNews objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildConcreteNews> find(?ConnectionInterface $con = null) Return ChildConcreteNews objects based on current ModelCriteria
 *
 * @method     ChildConcreteNews[]|Collection findByBody(string|array<string> $body) Return ChildConcreteNews objects filtered by the body column
 * @psalm-method Collection&\Traversable<ChildConcreteNews> findByBody(string|array<string> $body) Return ChildConcreteNews objects filtered by the body column
 * @method     ChildConcreteNews[]|Collection findByAuthorId(int|array<int> $author_id) Return ChildConcreteNews objects filtered by the author_id column
 * @psalm-method Collection&\Traversable<ChildConcreteNews> findByAuthorId(int|array<int> $author_id) Return ChildConcreteNews objects filtered by the author_id column
 * @method     ChildConcreteNews[]|Collection findById(int|array<int> $id) Return ChildConcreteNews objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildConcreteNews> findById(int|array<int> $id) Return ChildConcreteNews objects filtered by the id column
 * @method     ChildConcreteNews[]|Collection findByTitle(string|array<string> $title) Return ChildConcreteNews objects filtered by the title column
 * @psalm-method Collection&\Traversable<ChildConcreteNews> findByTitle(string|array<string> $title) Return ChildConcreteNews objects filtered by the title column
 * @method     ChildConcreteNews[]|Collection findByCategoryId(int|array<int> $category_id) Return ChildConcreteNews objects filtered by the category_id column
 * @psalm-method Collection&\Traversable<ChildConcreteNews> findByCategoryId(int|array<int> $category_id) Return ChildConcreteNews objects filtered by the category_id column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildConcreteNews> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class ConcreteNewsQuery extends ChildConcreteArticleQuery
{
     ...
     */
    public function __construct($dbName = 'bookstore-behavior', $modelName = '\\Propel\\Tests\\Bookstore\\Behavior\\ConcreteNews', ?string $modelAlias = null)
    {
    ...
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = ConcreteNewsTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            ConcreteNewsTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(ConcreteNewsTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(ConcreteNewsTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterByBody($body = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ConcreteNewsTableMap::COL_BODY, $body, $comparison);
    ...
    public function filterByAuthorId($authorId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ConcreteNewsTableMap::COL_AUTHOR_ID, $authorId, $comparison);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ConcreteNewsTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByTitle($title = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ConcreteNewsTableMap::COL_TITLE, $title, $comparison);
    ...
    public function filterByCategoryId($categoryId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ConcreteNewsTableMap::COL_CATEGORY_ID, $categoryId, $comparison);
