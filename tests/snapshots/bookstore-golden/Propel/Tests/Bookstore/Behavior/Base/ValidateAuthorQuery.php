 ...
 *
 * @method     ChildValidateAuthorQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildValidateAuthorQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildValidateAuthorQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 ...
 *
 * @method     ChildValidateAuthorQuery joinWithValidateBook($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the ValidateBook relation
 *
 * @method     ChildValidateAuthorQuery leftJoinWithValidateBook() Adds a LEFT JOIN clause and with to the query using the ValidateBook relation
 * @method     ChildValidateAuthorQuery rightJoinWithValidateBook() Adds a RIGHT JOIN clause and with to the query using the ValidateBook relation
 * @method     ChildValidateAuthorQuery innerJoinWithValidateBook() Adds a INNER JOIN clause and with to the query using the ValidateBook relation
 *
 ...
 *
 * @method     ChildValidateAuthor|null findOne(?ConnectionInterface $con = null) Return the first ChildValidateAuthor matching the query
 ...
 *
 * @method     ChildValidateAuthor|null findOneById(int $id) Return the first ChildValidateAuthor filtered by the id column
 * @method     ChildValidateAuthor|null findOneByFirstName(string $first_name) Return the first ChildValidateAuthor filtered by the first_name column
 * @method     ChildValidateAuthor|null findOneByLastName(string $last_name) Return the first ChildValidateAuthor filtered by the last_name column
 * @method     ChildValidateAuthor|null findOneByEmail(string $email) Return the first ChildValidateAuthor filtered by the email column
 * @method     ChildValidateAuthor|null findOneByBirthday(string $birthday) Return the first ChildValidateAuthor filtered by the birthday column
 *
 * @method     ChildValidateAuthor requirePk($key, ?ConnectionInterface $con = null) Return the ChildValidateAuthor by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildValidateAuthor requireOne(?ConnectionInterface $con = null) Return the first ChildValidateAuthor matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildValidateAuthor requireOneById(int $id) Return the first ChildValidateAuthor filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildValidateAuthor requireOneByFirstName(string $first_name) Return the first ChildValidateAuthor filtered by the first_name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildValidateAuthor requireOneByLastName(string $last_name) Return the first ChildValidateAuthor filtered by the last_name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildValidateAuthor requireOneByEmail(string $email) Return the first ChildValidateAuthor filtered by the email column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildValidateAuthor requireOneByBirthday(string $birthday) Return the first ChildValidateAuthor filtered by the birthday column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildValidateAuthor[]|Collection find(?ConnectionInterface $con = null) Return ChildValidateAuthor objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildValidateAuthor> find(?ConnectionInterface $con = null) Return ChildValidateAuthor objects based on current ModelCriteria
 *
 * @method     ChildValidateAuthor[]|Collection findById(int|array<int> $id) Return ChildValidateAuthor objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildValidateAuthor> findById(int|array<int> $id) Return ChildValidateAuthor objects filtered by the id column
 * @method     ChildValidateAuthor[]|Collection findByFirstName(string|array<string> $first_name) Return ChildValidateAuthor objects filtered by the first_name column
 * @psalm-method Collection&\Traversable<ChildValidateAuthor> findByFirstName(string|array<string> $first_name) Return ChildValidateAuthor objects filtered by the first_name column
 * @method     ChildValidateAuthor[]|Collection findByLastName(string|array<string> $last_name) Return ChildValidateAuthor objects filtered by the last_name column
 * @psalm-method Collection&\Traversable<ChildValidateAuthor> findByLastName(string|array<string> $last_name) Return ChildValidateAuthor objects filtered by the last_name column
 * @method     ChildValidateAuthor[]|Collection findByEmail(string|array<string> $email) Return ChildValidateAuthor objects filtered by the email column
 * @psalm-method Collection&\Traversable<ChildValidateAuthor> findByEmail(string|array<string> $email) Return ChildValidateAuthor objects filtered by the email column
 * @method     ChildValidateAuthor[]|Collection findByBirthday(string|array<string> $birthday) Return ChildValidateAuthor objects filtered by the birthday column
 * @psalm-method Collection&\Traversable<ChildValidateAuthor> findByBirthday(string|array<string> $birthday) Return ChildValidateAuthor objects filtered by the birthday column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildValidateAuthor> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class ValidateAuthorQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore-behavior', $modelName = '\\Propel\\Tests\\Bookstore\\Behavior\\ValidateAuthor', ?string $modelAlias = null)
    {
    ...
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = ValidateAuthorTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            ValidateAuthorTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(ValidateAuthorTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(ValidateAuthorTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ValidateAuthorTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByFirstName($firstName = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ValidateAuthorTableMap::COL_FIRST_NAME, $firstName, $comparison);
    ...
    public function filterByLastName($lastName = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ValidateAuthorTableMap::COL_LAST_NAME, $lastName, $comparison);
    ...
    public function filterByEmail($email = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ValidateAuthorTableMap::COL_EMAIL, $email, $comparison);
    ...
    public function filterByBirthday($birthday = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ValidateAuthorTableMap::COL_BIRTHDAY, $birthday, $comparison);
