...
abstract class ValidateBook implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Behavior\\Map\\ValidateBookTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildValidateReader> Cross Collection to store aggregation of ChildValidateReader objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildValidateReader>
     */
    ...
    {
        if (isset($alreadyDumpedObjects['ValidateBook'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['ValidateBook'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildValidateBookQuery::create();
        $criteria->add(ValidateBookTableMap::COL_ID, $this->id);
     ...
     *
     * @param ChildValidatePublisher|null $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @return ChildValidatePublisher|null The associated ChildValidatePublisher object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     *
     * @param ChildValidateAuthor|null $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildValidateAuthor|null The associated ChildValidateAuthor object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    /**
     * Initializes the collValidateReaders crossRef collection.
     *
    ...
    public function initValidateReaders()
    {
        ...
        $this->collValidateReaders = new $collectionClassName;
     ...
     * @return bool
     */
    public function isValidateReadersLoaded(): bool
    {
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildValidateReader> List of ChildValidateReader objects
     */
     ...
     */
    public function countValidateReaders(?Criteria $criteria = null, $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collValidateReadersPartial && !$this->isNew();
        if (null === $this->collValidateReaders || null !== $criteria || $partial) {
    ...
    public function validate(?ValidatorInterface $validator = null)
    {
        ...
        if (!$this->alreadyInValidation) {
            ...
            if (is_object($this->aValidatePublisher) and method_exists($this->aValidatePublisher, 'validate')) {
                if (!$this->aValidatePublisher->validate($validator)) {
                    $failureMap->addAll($this->aValidatePublisher->getValidationFailures());
                }
            }
            // If validate() method exists, the validate-behavior is configured for related object
            if (is_object($this->aValidateAuthor) and method_exists($this->aValidateAuthor, 'validate')) {
