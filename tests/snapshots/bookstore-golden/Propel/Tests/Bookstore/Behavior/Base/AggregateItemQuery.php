 ...
 *
 * @method     ChildAggregateItemQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildAggregateItemQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildAggregateItemQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 ...
 *
 * @method     ChildAggregateItemQuery joinWithAggregatePoll($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the AggregatePoll relation
 *
 * @method     ChildAggregateItemQuery leftJoinWithAggregatePoll() Adds a LEFT JOIN clause and with to the query using the AggregatePoll relation
 * @method     ChildAggregateItemQuery rightJoinWithAggregatePoll() Adds a RIGHT JOIN clause and with to the query using the AggregatePoll relation
 * @method     ChildAggregateItemQuery innerJoinWithAggregatePoll() Adds a INNER JOIN clause and with to the query using the AggregatePoll relation
 *
 ...
 *
 * @method     ChildAggregateItem|null findOne(?ConnectionInterface $con = null) Return the first ChildAggregateItem matching the query
 ...
 *
 * @method     ChildAggregateItem|null findOneById(int $id) Return the first ChildAggregateItem filtered by the id column
 * @method     ChildAggregateItem|null findOneByScore(int $score) Return the first ChildAggregateItem filtered by the score column
 * @method     ChildAggregateItem|null findOneByPollId(int $poll_id) Return the first ChildAggregateItem filtered by the poll_id column
 *
 * @method     ChildAggregateItem requirePk($key, ?ConnectionInterface $con = null) Return the ChildAggregateItem by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildAggregateItem requireOne(?ConnectionInterface $con = null) Return the first ChildAggregateItem matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildAggregateItem requireOneById(int $id) Return the first ChildAggregateItem filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildAggregateItem requireOneByScore(int $score) Return the first ChildAggregateItem filtered by the score column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildAggregateItem requireOneByPollId(int $poll_id) Return the first ChildAggregateItem filtered by the poll_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildAggregateItem[]|Collection find(?ConnectionInterface $con = null) Return ChildAggregateItem objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildAggregateItem> find(?ConnectionInterface $con = null) Return ChildAggregateItem objects based on current ModelCriteria
 *
 * @method     ChildAggregateItem[]|Collection findById(int|array<int> $id) Return ChildAggregateItem objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildAggregateItem> findById(int|array<int> $id) Return ChildAggregateItem objects filtered by the id column
 * @method     ChildAggregateItem[]|Collection findByScore(int|array<int> $score) Return ChildAggregateItem objects filtered by the score column
 * @psalm-method Collection&\Traversable<ChildAggregateItem> findByScore(int|array<int> $score) Return ChildAggregateItem objects filtered by the score column
 * @method     ChildAggregateItem[]|Collection findByPollId(int|array<int> $poll_id) Return ChildAggregateItem objects filtered by the poll_id column
 * @psalm-method Collection&\Traversable<ChildAggregateItem> findByPollId(int|array<int> $poll_id) Return ChildAggregateItem objects filtered by the poll_id column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildAggregateItem> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class AggregateItemQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore-behavior', $modelName = '\\Propel\\Tests\\Bookstore\\Behavior\\AggregateItem', ?string $modelAlias = null)
    {
    ...
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = AggregateItemTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            AggregateItemTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(AggregateItemTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(AggregateItemTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(AggregateItemTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByScore($score = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(AggregateItemTableMap::COL_SCORE, $score, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByPollId($pollId = null, ?string $comparison = null)
    {
        if (is_array($pollId)) {
            $useMinMax = false;
            if (isset($pollId['min'])) {
        ...
        $this->addUsingAlias(AggregateItemTableMap::COL_POLL_ID, $pollId, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByAggregatePoll($aggregatePoll, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinAggregatePoll(?string $relationAlias = null, ?string $joinType = Criteria::LEFT_JOIN)
    {
     ...
     */
    public function useAggregatePollQuery(?string $relationAlias = null, string $joinType = Criteria::LEFT_JOIN)
    {
        return $this
     ...
     * Use the AggregatePoll relation AggregatePoll object
     *
     * @param callable(\Propel\Tests\Bookstore\Behavior\AggregatePollQuery):\Propel\Tests\Bookstore\Behavior\AggregatePollQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @return $this
     */
    public function withAggregatePollQuery(
        callable $callable,
        ?string $relationAlias = null,
        ?string $joinType = Criteria::LEFT_JOIN
    ) {
        $relatedQuery = $this->useAggregatePollQuery(
            $relationAlias,
            $joinType
        );
    ...
    /**
     * Use the relation to AggregatePoll table for an EXISTS query.
     *
     ...
     *
     * @return \Propel\Tests\Bookstore\Behavior\AggregatePollQuery The inner query object of the EXISTS statement
     */
    public function useAggregatePollExistsQuery(?string $modelAlias = null, ?string $queryClass = null, string $typeOfExists = 'EXISTS')
    {
        /** @var $q \Propel\Tests\Bookstore\Behavior\AggregatePollQuery */
        $q = $this->useExistsQuery('AggregatePoll', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the relation to AggregatePoll table for a NOT EXISTS query.
     *
     * @see useAggregatePollExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \Propel\Tests\Bookstore\Behavior\AggregatePollQuery The inner query object of the NOT EXISTS statement
     */
    public function useAggregatePollNotExistsQuery(?string $modelAlias = null, ?string $queryClass = null)
    {
        /** @var $q \Propel\Tests\Bookstore\Behavior\AggregatePollQuery */
        $q = $this->useExistsQuery('AggregatePoll', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the relation to AggregatePoll table for an IN query.
     *
     ...
     *
     * @return \Propel\Tests\Bookstore\Behavior\AggregatePollQuery The inner query object of the IN statement
     */
    public function useInAggregatePollQuery(?string $modelAlias = null, ?string $queryClass = null, string $typeOfIn = 'IN')
    {
        /** @var $q \Propel\Tests\Bookstore\Behavior\AggregatePollQuery */
        $q = $this->useInQuery('AggregatePoll', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the relation to AggregatePoll table for a NOT IN query.
     *
     * @see useAggregatePollInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Propel\Tests\Bookstore\Behavior\AggregatePollQuery The inner query object of the NOT IN statement
     */
    public function useNotInAggregatePollQuery(?string $modelAlias = null, ?string $queryClass = null)
    {
        /** @var $q \Propel\Tests\Bookstore\Behavior\AggregatePollQuery */
        $q = $this->useInQuery('AggregatePoll', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
