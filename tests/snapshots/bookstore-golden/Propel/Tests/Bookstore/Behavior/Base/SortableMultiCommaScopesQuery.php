 ...
 *
 * @method     ChildSortableMultiCommaScopesQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildSortableMultiCommaScopesQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildSortableMultiCommaScopesQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 * @method     ChildSortableMultiCommaScopes|null findOne(?ConnectionInterface $con = null) Return the first ChildSortableMultiCommaScopes matching the query
 ...
 *
 * @method     ChildSortableMultiCommaScopes|null findOneById(int $id) Return the first ChildSortableMultiCommaScopes filtered by the id column
 * @method     ChildSortableMultiCommaScopes|null findOneByCategoryId(int $category_id) Return the first ChildSortableMultiCommaScopes filtered by the category_id column
 * @method     ChildSortableMultiCommaScopes|null findOneBySubCategoryId(int $sub_category_id) Return the first ChildSortableMultiCommaScopes filtered by the sub_category_id column
 * @method     ChildSortableMultiCommaScopes|null findOneByTitle(string $title) Return the first ChildSortableMultiCommaScopes filtered by the title column
 * @method     ChildSortableMultiCommaScopes|null findOneByPosition(int $position) Return the first ChildSortableMultiCommaScopes filtered by the position column
 *
 * @method     ChildSortableMultiCommaScopes requirePk($key, ?ConnectionInterface $con = null) Return the ChildSortableMultiCommaScopes by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSortableMultiCommaScopes requireOne(?ConnectionInterface $con = null) Return the first ChildSortableMultiCommaScopes matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildSortableMultiCommaScopes requireOneById(int $id) Return the first ChildSortableMultiCommaScopes filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSortableMultiCommaScopes requireOneByCategoryId(int $category_id) Return the first ChildSortableMultiCommaScopes filtered by the category_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSortableMultiCommaScopes requireOneBySubCategoryId(int $sub_category_id) Return the first ChildSortableMultiCommaScopes filtered by the sub_category_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSortableMultiCommaScopes requireOneByTitle(string $title) Return the first ChildSortableMultiCommaScopes filtered by the title column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSortableMultiCommaScopes requireOneByPosition(int $position) Return the first ChildSortableMultiCommaScopes filtered by the position column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildSortableMultiCommaScopes[]|Collection find(?ConnectionInterface $con = null) Return ChildSortableMultiCommaScopes objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSortableMultiCommaScopes> find(?ConnectionInterface $con = null) Return ChildSortableMultiCommaScopes objects based on current ModelCriteria
 *
 * @method     ChildSortableMultiCommaScopes[]|Collection findById(int|array<int> $id) Return ChildSortableMultiCommaScopes objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildSortableMultiCommaScopes> findById(int|array<int> $id) Return ChildSortableMultiCommaScopes objects filtered by the id column
 * @method     ChildSortableMultiCommaScopes[]|Collection findByCategoryId(int|array<int> $category_id) Return ChildSortableMultiCommaScopes objects filtered by the category_id column
 * @psalm-method Collection&\Traversable<ChildSortableMultiCommaScopes> findByCategoryId(int|array<int> $category_id) Return ChildSortableMultiCommaScopes objects filtered by the category_id column
 * @method     ChildSortableMultiCommaScopes[]|Collection findBySubCategoryId(int|array<int> $sub_category_id) Return ChildSortableMultiCommaScopes objects filtered by the sub_category_id column
 * @psalm-method Collection&\Traversable<ChildSortableMultiCommaScopes> findBySubCategoryId(int|array<int> $sub_category_id) Return ChildSortableMultiCommaScopes objects filtered by the sub_category_id column
 * @method     ChildSortableMultiCommaScopes[]|Collection findByTitle(string|array<string> $title) Return ChildSortableMultiCommaScopes objects filtered by the title column
 * @psalm-method Collection&\Traversable<ChildSortableMultiCommaScopes> findByTitle(string|array<string> $title) Return ChildSortableMultiCommaScopes objects filtered by the title column
 * @method     ChildSortableMultiCommaScopes[]|Collection findByPosition(int|array<int> $position) Return ChildSortableMultiCommaScopes objects filtered by the position column
 * @psalm-method Collection&\Traversable<ChildSortableMultiCommaScopes> findByPosition(int|array<int> $position) Return ChildSortableMultiCommaScopes objects filtered by the position column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildSortableMultiCommaScopes> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class SortableMultiCommaScopesQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore-behavior', $modelName = '\\Propel\\Tests\\Bookstore\\Behavior\\SortableMultiCommaScopes', ?string $modelAlias = null)
    {
    ...
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SortableMultiCommaScopesTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SortableMultiCommaScopesTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SortableMultiCommaScopesTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SortableMultiCommaScopesTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SortableMultiCommaScopesTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByCategoryId($categoryId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SortableMultiCommaScopesTableMap::COL_CATEGORY_ID, $categoryId, $comparison);
    ...
    public function filterBySubCategoryId($subCategoryId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SortableMultiCommaScopesTableMap::COL_SUB_CATEGORY_ID, $subCategoryId, $comparison);
    ...
    public function filterByTitle($title = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SortableMultiCommaScopesTableMap::COL_TITLE, $title, $comparison);
    ...
    public function filterByPosition($position = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SortableMultiCommaScopesTableMap::COL_POSITION, $position, $comparison);
    ...
    public function orderByRank(string $order = Criteria::ASC)
    {
        ...
        switch ($order) {
            case Criteria::ASC:
                $this->addAscendingOrderByColumn($this->getAliasedColName(SortableMultiCommaScopesTableMap::RANK_COL));

                return $this;
            case Criteria::DESC:
                $this->addDescendingOrderByColumn($this->getAliasedColName(SortableMultiCommaScopesTableMap::RANK_COL));
