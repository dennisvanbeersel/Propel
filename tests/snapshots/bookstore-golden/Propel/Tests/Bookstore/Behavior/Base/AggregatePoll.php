...
abstract class AggregatePoll implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Behavior\\Map\\AggregatePollTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildAggregateItem>
     */
    ...
    {
        if (isset($alreadyDumpedObjects['AggregatePoll'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['AggregatePoll'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildAggregatePollQuery::create();
        $criteria->add(AggregatePollTableMap::COL_ID, $this->id);
     ...
     * @return void
     */
    public function resetPartialAggregateItems($v = true): void
    {
     ...
     * @return void
     */
    public function initAggregateItems(bool $overrideExisting = true): void
    {
        if (null !== $this->collAggregateItems && !$overrideExisting) {
            return;
        }

        $collectionClassName = AggregateItemTableMap::getTableMap()->getCollectionClassName();

        $this->collAggregateItems = new $collectionClassName;
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildAggregateItem> List of ChildAggregateItem objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collAggregateItems || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collAggregateItems) {
                    ...
                    $collAggregateItems = new $collectionClassName;
                    $collAggregateItems->setModel('\Propel\Tests\Bookstore\Behavior\AggregateItem');
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countAggregateItems(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collAggregateItemsPartial && !$this->isNew();
        if (null === $this->collAggregateItems || null !== $criteria || $partial) {
    ...
    public function addAggregateItem(ChildAggregateItem $l)
    {
        ...
        if (!$this->collAggregateItems->contains($l)) {
            ...
            if ($this->aggregateItemsScheduledForDeletion and $this->aggregateItemsScheduledForDeletion->contains($l)) {
                $this->aggregateItemsScheduledForDeletion->remove($this->aggregateItemsScheduledForDeletion->search($l));
            }
        }
     ...
     */
    protected function doAddAggregateItem(ChildAggregateItem $aggregateItem): void
    {
