...
abstract class SortableMultiCommaScopes implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Behavior\\Map\\SortableMultiCommaScopesTableMap';
    ...
    {
        $pos = (int)SortableMultiCommaScopesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SortableMultiCommaScopes'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['SortableMultiCommaScopes'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildSortableMultiCommaScopesQuery::create();
        $criteria->add(SortableMultiCommaScopesTableMap::COL_ID, $this->id);
