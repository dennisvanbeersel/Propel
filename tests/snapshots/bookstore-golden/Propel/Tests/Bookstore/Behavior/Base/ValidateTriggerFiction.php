...
abstract class ValidateTriggerFiction extends ChildValidateTriggerBook implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Behavior\\Map\\ValidateTriggerFictionTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildValidateTriggerFictionI18n> Collection to store aggregation of ChildValidateTriggerFictionI18n objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildValidateTriggerFictionI18n>
     */
    ...
    {
        if (isset($alreadyDumpedObjects['ValidateTriggerFiction'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['ValidateTriggerFiction'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildValidateTriggerFictionQuery::create();
        $criteria->add(ValidateTriggerFictionTableMap::COL_ID, $this->id);
     ...
     * @return void
     */
    public function resetPartialValidateTriggerFictionI18ns($v = true): void
    {
     ...
     * @return void
     */
    public function initValidateTriggerFictionI18ns(bool $overrideExisting = true): void
    {
        if (null !== $this->collValidateTriggerFictionI18ns && !$overrideExisting) {
            return;
        }

        $collectionClassName = ValidateTriggerFictionI18nTableMap::getTableMap()->getCollectionClassName();

        $this->collValidateTriggerFictionI18ns = new $collectionClassName;
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildValidateTriggerFictionI18n> List of ChildValidateTriggerFictionI18n objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collValidateTriggerFictionI18ns || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collValidateTriggerFictionI18ns) {
                    ...
                    $collValidateTriggerFictionI18ns = new $collectionClassName;
                    $collValidateTriggerFictionI18ns->setModel('\Propel\Tests\Bookstore\Behavior\ValidateTriggerFictionI18n');
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countValidateTriggerFictionI18ns(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collValidateTriggerFictionI18nsPartial && !$this->isNew();
        if (null === $this->collValidateTriggerFictionI18ns || null !== $criteria || $partial) {
    ...
    public function addValidateTriggerFictionI18n(ChildValidateTriggerFictionI18n $l)
    {
        ...
        if (!$this->collValidateTriggerFictionI18ns->contains($l)) {
            ...
            if ($this->validateTriggerFictionI18nsScheduledForDeletion and $this->validateTriggerFictionI18nsScheduledForDeletion->contains($l)) {
                $this->validateTriggerFictionI18nsScheduledForDeletion->remove($this->validateTriggerFictionI18nsScheduledForDeletion->search($l));
            }
        }
     ...
     */
    protected function doAddValidateTriggerFictionI18n(ChildValidateTriggerFictionI18n $validateTriggerFictionI18n): void
    {
    ...
    public function validate(?ValidatorInterface $validator = null)
    {
        ...
        if (!$this->alreadyInValidation) {
            ...
            if (is_object($this->aValidateTriggerBook) and method_exists($this->aValidateTriggerBook, 'validate')) {
