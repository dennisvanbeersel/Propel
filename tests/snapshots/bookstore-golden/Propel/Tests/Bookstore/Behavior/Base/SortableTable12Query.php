 ...
 *
 * @method     ChildSortableTable12Query leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildSortableTable12Query rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildSortableTable12Query innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 * @method     ChildSortableTable12|null findOne(?ConnectionInterface $con = null) Return the first ChildSortableTable12 matching the query
 ...
 *
 * @method     ChildSortableTable12|null findOneById(int $id) Return the first ChildSortableTable12 filtered by the id column
 * @method     ChildSortableTable12|null findOneByTitle(string $title) Return the first ChildSortableTable12 filtered by the title column
 * @method     ChildSortableTable12|null findOneByPosition(int $position) Return the first ChildSortableTable12 filtered by the position column
 * @method     ChildSortableTable12|null findOneByMyScopeColumn(int $my_scope_column) Return the first ChildSortableTable12 filtered by the my_scope_column column
 *
 * @method     ChildSortableTable12 requirePk($key, ?ConnectionInterface $con = null) Return the ChildSortableTable12 by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSortableTable12 requireOne(?ConnectionInterface $con = null) Return the first ChildSortableTable12 matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildSortableTable12 requireOneById(int $id) Return the first ChildSortableTable12 filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSortableTable12 requireOneByTitle(string $title) Return the first ChildSortableTable12 filtered by the title column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSortableTable12 requireOneByPosition(int $position) Return the first ChildSortableTable12 filtered by the position column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSortableTable12 requireOneByMyScopeColumn(int $my_scope_column) Return the first ChildSortableTable12 filtered by the my_scope_column column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildSortableTable12[]|Collection find(?ConnectionInterface $con = null) Return ChildSortableTable12 objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSortableTable12> find(?ConnectionInterface $con = null) Return ChildSortableTable12 objects based on current ModelCriteria
 *
 * @method     ChildSortableTable12[]|Collection findById(int|array<int> $id) Return ChildSortableTable12 objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildSortableTable12> findById(int|array<int> $id) Return ChildSortableTable12 objects filtered by the id column
 * @method     ChildSortableTable12[]|Collection findByTitle(string|array<string> $title) Return ChildSortableTable12 objects filtered by the title column
 * @psalm-method Collection&\Traversable<ChildSortableTable12> findByTitle(string|array<string> $title) Return ChildSortableTable12 objects filtered by the title column
 * @method     ChildSortableTable12[]|Collection findByPosition(int|array<int> $position) Return ChildSortableTable12 objects filtered by the position column
 * @psalm-method Collection&\Traversable<ChildSortableTable12> findByPosition(int|array<int> $position) Return ChildSortableTable12 objects filtered by the position column
 * @method     ChildSortableTable12[]|Collection findByMyScopeColumn(int|array<int> $my_scope_column) Return ChildSortableTable12 objects filtered by the my_scope_column column
 * @psalm-method Collection&\Traversable<ChildSortableTable12> findByMyScopeColumn(int|array<int> $my_scope_column) Return ChildSortableTable12 objects filtered by the my_scope_column column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildSortableTable12> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class SortableTable12Query extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore-behavior', $modelName = '\\Propel\\Tests\\Bookstore\\Behavior\\SortableTable12', ?string $modelAlias = null)
    {
    ...
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SortableTable12TableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SortableTable12TableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SortableTable12TableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SortableTable12TableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SortableTable12TableMap::COL_ID, $id, $comparison);
    ...
    public function filterByTitle($title = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SortableTable12TableMap::COL_TITLE, $title, $comparison);
    ...
    public function filterByPosition($position = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SortableTable12TableMap::COL_POSITION, $position, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByMyScopeColumn($myScopeColumn = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(SortableTable12TableMap::COL_MY_SCOPE_COLUMN, $myScopeColumn, $comparison);
    ...
    public function orderByRank(string $order = Criteria::ASC)
    {
        ...
        switch ($order) {
            case Criteria::ASC:
                $this->addAscendingOrderByColumn($this->getAliasedColName(SortableTable12TableMap::RANK_COL));

                return $this;
            case Criteria::DESC:
                $this->addDescendingOrderByColumn($this->getAliasedColName(SortableTable12TableMap::RANK_COL));
