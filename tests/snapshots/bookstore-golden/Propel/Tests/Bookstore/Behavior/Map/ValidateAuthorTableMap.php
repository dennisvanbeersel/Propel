...
class ValidateAuthorTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Propel.Tests.Bookstore.Behavior.Map.ValidateAuthorTableMap';
     ...
     */
    public const TABLE_NAME = 'validate_author';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'ValidateAuthor';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Behavior\\ValidateAuthor';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Behavior.ValidateAuthor';
     ...
     */
    public const COL_ID = 'validate_author.id';

    /**
     * the column name for the first_name field
     */
    public const COL_FIRST_NAME = 'validate_author.first_name';

    /**
     * the column name for the last_name field
     */
    public const COL_LAST_NAME = 'validate_author.last_name';

    /**
     * the column name for the email field
     */
    public const COL_EMAIL = 'validate_author.email';

    /**
     * the column name for the birthday field
     */
    public const COL_BIRTHDAY = 'validate_author.birthday';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [ValidateAuthorTableMap::COL_ID, ValidateAuthorTableMap::COL_FIRST_NAME, ValidateAuthorTableMap::COL_LAST_NAME, ValidateAuthorTableMap::COL_EMAIL, ValidateAuthorTableMap::COL_BIRTHDAY, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [ValidateAuthorTableMap::COL_ID => 0, ValidateAuthorTableMap::COL_FIRST_NAME => 1, ValidateAuthorTableMap::COL_LAST_NAME => 2, ValidateAuthorTableMap::COL_EMAIL => 3, ValidateAuthorTableMap::COL_BIRTHDAY => 4, ],
    ...
    protected array $normalizedColumnNameMap = [
        'Id' => 'ID',
        'ValidateAuthor.Id' => 'ID',
        'id' => 'ID',
        'validateAuthor.id' => 'ID',
        'ValidateAuthorTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'validate_author.id' => 'ID',
        'FirstName' => 'FIRST_NAME',
        'ValidateAuthor.FirstName' => 'FIRST_NAME',
        'firstName' => 'FIRST_NAME',
        'validateAuthor.firstName' => 'FIRST_NAME',
        'ValidateAuthorTableMap::COL_FIRST_NAME' => 'FIRST_NAME',
        'COL_FIRST_NAME' => 'FIRST_NAME',
        'first_name' => 'FIRST_NAME',
        'validate_author.first_name' => 'FIRST_NAME',
        'LastName' => 'LAST_NAME',
        'ValidateAuthor.LastName' => 'LAST_NAME',
        'lastName' => 'LAST_NAME',
        'validateAuthor.lastName' => 'LAST_NAME',
        'ValidateAuthorTableMap::COL_LAST_NAME' => 'LAST_NAME',
        'COL_LAST_NAME' => 'LAST_NAME',
        'last_name' => 'LAST_NAME',
        'validate_author.last_name' => 'LAST_NAME',
        'Email' => 'EMAIL',
        'ValidateAuthor.Email' => 'EMAIL',
        'email' => 'EMAIL',
        'validateAuthor.email' => 'EMAIL',
        'ValidateAuthorTableMap::COL_EMAIL' => 'EMAIL',
        'COL_EMAIL' => 'EMAIL',
        'validate_author.email' => 'EMAIL',
        'Birthday' => 'BIRTHDAY',
        'ValidateAuthor.Birthday' => 'BIRTHDAY',
        'birthday' => 'BIRTHDAY',
        'validateAuthor.birthday' => 'BIRTHDAY',
        'ValidateAuthorTableMap::COL_BIRTHDAY' => 'BIRTHDAY',
        'COL_BIRTHDAY' => 'BIRTHDAY',
        'validate_author.birthday' => 'BIRTHDAY',
    ];
  ...
  array (
...
), 'SET NULL', 'CASCADE', 'ValidateBooks', false);
    }
    ...
    {
        return [
            'validate' => ['rule1' => ['column' => 'first_name', 'validator' => 'NotNull'], 'rule2' => ['column' => 'first_name', 'validator' => 'Length', 'options' => ['max' => 128]], 'rule3' => ['column' => 'last_name', 'validator' => 'NotNull'], 'rule4' => ['column' => 'last_name', 'validator' => 'Length', 'options' => ['max' => 128]], 'rule5' => ['column' => 'email', 'validator' => 'Email'], 'rule6' => ['column' => 'birthday', 'validator' => 'Date']],
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(ValidateAuthorTableMap::COL_ID);
            $criteria->removeSelectColumn(ValidateAuthorTableMap::COL_FIRST_NAME);
            $criteria->removeSelectColumn(ValidateAuthorTableMap::COL_LAST_NAME);
            $criteria->removeSelectColumn(ValidateAuthorTableMap::COL_EMAIL);
            $criteria->removeSelectColumn(ValidateAuthorTableMap::COL_BIRTHDAY);
        } else {
