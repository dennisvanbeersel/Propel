...
class ValidateTriggerFictionTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Propel.Tests.Bookstore.Behavior.Map.ValidateTriggerFictionTableMap';
     ...
     */
    public const TABLE_NAME = 'validate_trigger_fiction';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'ValidateTriggerFiction';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Behavior\\ValidateTriggerFiction';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Behavior.ValidateTriggerFiction';
     ...
     */
    public const COL_FOO = 'validate_trigger_fiction.foo';

    /**
     * the column name for the id field
     */
    public const COL_ID = 'validate_trigger_fiction.id';

    /**
     * the column name for the isbn field
     */
    public const COL_ISBN = 'validate_trigger_fiction.isbn';

    /**
     * the column name for the price field
     */
    public const COL_PRICE = 'validate_trigger_fiction.price';

    /**
     * the column name for the publisher_id field
     */
    public const COL_PUBLISHER_ID = 'validate_trigger_fiction.publisher_id';

    /**
     * the column name for the author_id field
     */
    public const COL_AUTHOR_ID = 'validate_trigger_fiction.author_id';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Foo', 'Id', 'ISBN', 'Price', 'PublisherId', 'AuthorId', ],
        self::TYPE_CAMELNAME     => ['foo', 'id', 'iSBN', 'price', 'publisherId', 'authorId', ],
        self::TYPE_COLNAME       => [ValidateTriggerFictionTableMap::COL_FOO, ValidateTriggerFictionTableMap::COL_ID, ValidateTriggerFictionTableMap::COL_ISBN, ValidateTriggerFictionTableMap::COL_PRICE, ValidateTriggerFictionTableMap::COL_PUBLISHER_ID, ValidateTriggerFictionTableMap::COL_AUTHOR_ID, ],
        self::TYPE_FIELDNAME     => ['foo', 'id', 'isbn', 'price', 'publisher_id', 'author_id', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Foo' => 0, 'Id' => 1, 'ISBN' => 2, 'Price' => 3, 'PublisherId' => 4, 'AuthorId' => 5, ],
        self::TYPE_CAMELNAME     => ['foo' => 0, 'id' => 1, 'iSBN' => 2, 'price' => 3, 'publisherId' => 4, 'authorId' => 5, ],
        self::TYPE_COLNAME       => [ValidateTriggerFictionTableMap::COL_FOO => 0, ValidateTriggerFictionTableMap::COL_ID => 1, ValidateTriggerFictionTableMap::COL_ISBN => 2, ValidateTriggerFictionTableMap::COL_PRICE => 3, ValidateTriggerFictionTableMap::COL_PUBLISHER_ID => 4, ValidateTriggerFictionTableMap::COL_AUTHOR_ID => 5, ],
        self::TYPE_FIELDNAME     => ['foo' => 0, 'id' => 1, 'isbn' => 2, 'price' => 3, 'publisher_id' => 4, 'author_id' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
    ...
    protected array $normalizedColumnNameMap = [
        'Foo' => 'FOO',
        'ValidateTriggerFiction.Foo' => 'FOO',
        'foo' => 'FOO',
        'validateTriggerFiction.foo' => 'FOO',
        'ValidateTriggerFictionTableMap::COL_FOO' => 'FOO',
        'COL_FOO' => 'FOO',
        'validate_trigger_fiction.foo' => 'FOO',
        'Id' => 'ID',
        'ValidateTriggerFiction.Id' => 'ID',
        'id' => 'ID',
        'validateTriggerFiction.id' => 'ID',
        'ValidateTriggerFictionTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'validate_trigger_fiction.id' => 'ID',
        'ISBN' => 'ISBN',
        'ValidateTriggerFiction.ISBN' => 'ISBN',
        'iSBN' => 'ISBN',
        'validateTriggerFiction.iSBN' => 'ISBN',
        'ValidateTriggerFictionTableMap::COL_ISBN' => 'ISBN',
        'COL_ISBN' => 'ISBN',
        'isbn' => 'ISBN',
        'validate_trigger_fiction.isbn' => 'ISBN',
        'Price' => 'PRICE',
        'ValidateTriggerFiction.Price' => 'PRICE',
        'price' => 'PRICE',
        'validateTriggerFiction.price' => 'PRICE',
        'ValidateTriggerFictionTableMap::COL_PRICE' => 'PRICE',
        'COL_PRICE' => 'PRICE',
        'validate_trigger_fiction.price' => 'PRICE',
        'PublisherId' => 'PUBLISHER_ID',
        'ValidateTriggerFiction.PublisherId' => 'PUBLISHER_ID',
        'publisherId' => 'PUBLISHER_ID',
        'validateTriggerFiction.publisherId' => 'PUBLISHER_ID',
        'ValidateTriggerFictionTableMap::COL_PUBLISHER_ID' => 'PUBLISHER_ID',
        'COL_PUBLISHER_ID' => 'PUBLISHER_ID',
        'publisher_id' => 'PUBLISHER_ID',
        'validate_trigger_fiction.publisher_id' => 'PUBLISHER_ID',
        'AuthorId' => 'AUTHOR_ID',
        'ValidateTriggerFiction.AuthorId' => 'AUTHOR_ID',
        'authorId' => 'AUTHOR_ID',
        'validateTriggerFiction.authorId' => 'AUTHOR_ID',
        'ValidateTriggerFictionTableMap::COL_AUTHOR_ID' => 'AUTHOR_ID',
        'COL_AUTHOR_ID' => 'AUTHOR_ID',
        'author_id' => 'AUTHOR_ID',
        'validate_trigger_fiction.author_id' => 'AUTHOR_ID',
    ];
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('ValidateTriggerFictionI18n', '\\Propel\\Tests\\Bookstore\\Behavior\\ValidateTriggerFictionI18n', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
  ),
), 'CASCADE', null, 'ValidateTriggerFictionI18ns', false);
    }
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(ValidateTriggerFictionTableMap::COL_FOO);
            $criteria->removeSelectColumn(ValidateTriggerFictionTableMap::COL_ID);
            $criteria->removeSelectColumn(ValidateTriggerFictionTableMap::COL_ISBN);
            $criteria->removeSelectColumn(ValidateTriggerFictionTableMap::COL_PRICE);
            $criteria->removeSelectColumn(ValidateTriggerFictionTableMap::COL_PUBLISHER_ID);
            $criteria->removeSelectColumn(ValidateTriggerFictionTableMap::COL_AUTHOR_ID);
        } else {
            $criteria->removeSelectColumn($alias . '.foo');
