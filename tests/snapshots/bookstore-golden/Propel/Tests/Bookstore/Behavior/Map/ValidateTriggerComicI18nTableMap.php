...
class ValidateTriggerComicI18nTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Propel.Tests.Bookstore.Behavior.Map.ValidateTriggerComicI18nTableMap';
     ...
     */
    public const TABLE_NAME = 'validate_trigger_comic_i18n';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'ValidateTriggerComicI18n';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Behavior\\ValidateTriggerComicI18n';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Behavior.ValidateTriggerComicI18n';
     ...
     */
    public const COL_ID = 'validate_trigger_comic_i18n.id';

    /**
     * the column name for the locale field
     */
    public const COL_LOCALE = 'validate_trigger_comic_i18n.locale';

    /**
     * the column name for the title field
     */
    public const COL_TITLE = 'validate_trigger_comic_i18n.title';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [ValidateTriggerComicI18nTableMap::COL_ID, ValidateTriggerComicI18nTableMap::COL_LOCALE, ValidateTriggerComicI18nTableMap::COL_TITLE, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [ValidateTriggerComicI18nTableMap::COL_ID => 0, ValidateTriggerComicI18nTableMap::COL_LOCALE => 1, ValidateTriggerComicI18nTableMap::COL_TITLE => 2, ],
    ...
    protected array $normalizedColumnNameMap = [
        'Id' => 'ID',
        'ValidateTriggerComicI18n.Id' => 'ID',
        'id' => 'ID',
        'validateTriggerComicI18n.id' => 'ID',
        'ValidateTriggerComicI18nTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'validate_trigger_comic_i18n.id' => 'ID',
        'Locale' => 'LOCALE',
        'ValidateTriggerComicI18n.Locale' => 'LOCALE',
        'locale' => 'LOCALE',
        'validateTriggerComicI18n.locale' => 'LOCALE',
        'ValidateTriggerComicI18nTableMap::COL_LOCALE' => 'LOCALE',
        'COL_LOCALE' => 'LOCALE',
        'validate_trigger_comic_i18n.locale' => 'LOCALE',
        'Title' => 'TITLE',
        'ValidateTriggerComicI18n.Title' => 'TITLE',
        'title' => 'TITLE',
        'validateTriggerComicI18n.title' => 'TITLE',
        'ValidateTriggerComicI18nTableMap::COL_TITLE' => 'TITLE',
        'COL_TITLE' => 'TITLE',
        'validate_trigger_comic_i18n.title' => 'TITLE',
    ];
    ...
    {
        $this->addRelation('ValidateTriggerComic', '\\Propel\\Tests\\Bookstore\\Behavior\\ValidateTriggerComic', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
    ...
    {
        return [
            'validate' => ['rule3' => ['column' => 'title', 'validator' => 'NotNull']],
        ];
    }
     ...
     * @return void
     */
    public static function addInstanceToPool(ValidateTriggerComicI18n $obj, ?string $key = null): void
    {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(ValidateTriggerComicI18nTableMap::COL_ID);
            $criteria->removeSelectColumn(ValidateTriggerComicI18nTableMap::COL_LOCALE);
            $criteria->removeSelectColumn(ValidateTriggerComicI18nTableMap::COL_TITLE);
        } else {
