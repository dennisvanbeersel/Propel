...
class SortableMultiCommaScopesTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Propel.Tests.Bookstore.Behavior.Map.SortableMultiCommaScopesTableMap';
     ...
     */
    public const TABLE_NAME = 'sortable_multi_comma_scopes';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SortableMultiCommaScopes';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Behavior\\SortableMultiCommaScopes';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Behavior.SortableMultiCommaScopes';
     ...
     */
    public const COL_ID = 'sortable_multi_comma_scopes.id';

    /**
     * the column name for the category_id field
     */
    public const COL_CATEGORY_ID = 'sortable_multi_comma_scopes.category_id';

    /**
     * the column name for the sub_category_id field
     */
    public const COL_SUB_CATEGORY_ID = 'sortable_multi_comma_scopes.sub_category_id';

    /**
     * the column name for the title field
     */
    public const COL_TITLE = 'sortable_multi_comma_scopes.title';

    /**
     * the column name for the position field
     */
    public const COL_POSITION = 'sortable_multi_comma_scopes.position';
    ...
    */
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'CategoryId', 'SubCategoryId', 'Title', 'Position', ],
        self::TYPE_CAMELNAME     => ['id', 'categoryId', 'subCategoryId', 'title', 'position', ],
        self::TYPE_COLNAME       => [SortableMultiCommaScopesTableMap::COL_ID, SortableMultiCommaScopesTableMap::COL_CATEGORY_ID, SortableMultiCommaScopesTableMap::COL_SUB_CATEGORY_ID, SortableMultiCommaScopesTableMap::COL_TITLE, SortableMultiCommaScopesTableMap::COL_POSITION, ],
        self::TYPE_FIELDNAME     => ['id', 'category_id', 'sub_category_id', 'title', 'position', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'CategoryId' => 1, 'SubCategoryId' => 2, 'Title' => 3, 'Position' => 4, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'categoryId' => 1, 'subCategoryId' => 2, 'title' => 3, 'position' => 4, ],
        self::TYPE_COLNAME       => [SortableMultiCommaScopesTableMap::COL_ID => 0, SortableMultiCommaScopesTableMap::COL_CATEGORY_ID => 1, SortableMultiCommaScopesTableMap::COL_SUB_CATEGORY_ID => 2, SortableMultiCommaScopesTableMap::COL_TITLE => 3, SortableMultiCommaScopesTableMap::COL_POSITION => 4, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'category_id' => 1, 'sub_category_id' => 2, 'title' => 3, 'position' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected array $normalizedColumnNameMap = [
        'Id' => 'ID',
        'SortableMultiCommaScopes.Id' => 'ID',
        'id' => 'ID',
        'sortableMultiCommaScopes.id' => 'ID',
        'SortableMultiCommaScopesTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'sortable_multi_comma_scopes.id' => 'ID',
        'CategoryId' => 'CATEGORY_ID',
        'SortableMultiCommaScopes.CategoryId' => 'CATEGORY_ID',
        'categoryId' => 'CATEGORY_ID',
        'sortableMultiCommaScopes.categoryId' => 'CATEGORY_ID',
        'SortableMultiCommaScopesTableMap::COL_CATEGORY_ID' => 'CATEGORY_ID',
        'COL_CATEGORY_ID' => 'CATEGORY_ID',
        'category_id' => 'CATEGORY_ID',
        'sortable_multi_comma_scopes.category_id' => 'CATEGORY_ID',
        'SubCategoryId' => 'SUB_CATEGORY_ID',
        'SortableMultiCommaScopes.SubCategoryId' => 'SUB_CATEGORY_ID',
        'subCategoryId' => 'SUB_CATEGORY_ID',
        'sortableMultiCommaScopes.subCategoryId' => 'SUB_CATEGORY_ID',
        'SortableMultiCommaScopesTableMap::COL_SUB_CATEGORY_ID' => 'SUB_CATEGORY_ID',
        'COL_SUB_CATEGORY_ID' => 'SUB_CATEGORY_ID',
        'sub_category_id' => 'SUB_CATEGORY_ID',
        'sortable_multi_comma_scopes.sub_category_id' => 'SUB_CATEGORY_ID',
        'Title' => 'TITLE',
        'SortableMultiCommaScopes.Title' => 'TITLE',
        'title' => 'TITLE',
        'sortableMultiCommaScopes.title' => 'TITLE',
        'SortableMultiCommaScopesTableMap::COL_TITLE' => 'TITLE',
        'COL_TITLE' => 'TITLE',
        'sortable_multi_comma_scopes.title' => 'TITLE',
        'Position' => 'POSITION',
        'SortableMultiCommaScopes.Position' => 'POSITION',
        'position' => 'POSITION',
        'sortableMultiCommaScopes.position' => 'POSITION',
        'SortableMultiCommaScopesTableMap::COL_POSITION' => 'POSITION',
        'COL_POSITION' => 'POSITION',
        'sortable_multi_comma_scopes.position' => 'POSITION',
    ];
    ...
    {
        return [
            'sortable' => ['rank_column' => 'position', 'use_scope' => 'true', 'scope_column' => 'category_id, sub_category_id'],
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(SortableMultiCommaScopesTableMap::COL_ID);
            $criteria->removeSelectColumn(SortableMultiCommaScopesTableMap::COL_CATEGORY_ID);
            $criteria->removeSelectColumn(SortableMultiCommaScopesTableMap::COL_SUB_CATEGORY_ID);
            $criteria->removeSelectColumn(SortableMultiCommaScopesTableMap::COL_TITLE);
            $criteria->removeSelectColumn(SortableMultiCommaScopesTableMap::COL_POSITION);
        } else {
            $criteria->removeSelectColumn($alias . '.id');
            $criteria->removeSelectColumn($alias . '.category_id');
            $criteria->removeSelectColumn($alias . '.sub_category_id');
