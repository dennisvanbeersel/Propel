...
class BookstoreEmployeeTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Propel.Tests.Bookstore.Map.BookstoreEmployeeTableMap';
     ...
     */
    public const TABLE_NAME = 'bookstore_employee';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'BookstoreEmployee';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Propel\\Tests\\Bookstore\\BookstoreEmployee';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Propel.Tests.Bookstore.BookstoreEmployee';
     ...
     */
    public const NUM_LAZY_LOAD_COLUMNS = 1;
     ...
     */
    public const COL_ID = 'bookstore_employee.id';

    /**
     * the column name for the class_key field
     */
    public const COL_CLASS_KEY = 'bookstore_employee.class_key';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'bookstore_employee.name';

    /**
     * the column name for the job_title field
     */
    public const COL_JOB_TITLE = 'bookstore_employee.job_title';

    /**
     * the column name for the supervisor_id field
     */
    public const COL_SUPERVISOR_ID = 'bookstore_employee.supervisor_id';

    /**
     * the column name for the photo field
     */
    public const COL_PHOTO = 'bookstore_employee.photo';
    ...
    public const CLASSKEY_0 = '0';

    /** A key representing a particular subclass */
    public const CLASSKEY_BOOKSTOREEMPLOYEE = '\\Propel\\Tests\\Bookstore\\BookstoreEmployee';

    /** A class that can be returned by this tableMap. */
    public const CLASSNAME_0 = '\\Propel\\Tests\\Bookstore\\BookstoreEmployee';

    /** A key representing a particular subclass */
    public const CLASSKEY_1 = '1';

    /** A key representing a particular subclass */
    public const CLASSKEY_BOOKSTOREMANAGER = '\\Propel\\Tests\\Bookstore\\BookstoreManager';

    /** A class that can be returned by this tableMap. */
    public const CLASSNAME_1 = '\\Propel\\Tests\\Bookstore\\BookstoreManager';

    /** A key representing a particular subclass */
    public const CLASSKEY_2 = '2';

    /** A key representing a particular subclass */
    public const CLASSKEY_BOOKSTORECASHIER = '\\Propel\\Tests\\Bookstore\\BookstoreCashier';

    /** A class that can be returned by this tableMap. */
    public const CLASSNAME_2 = '\\Propel\\Tests\\Bookstore\\BookstoreCashier';

    /** A key representing a particular subclass */
    public const CLASSKEY_3 = '3';

    /** A key representing a particular subclass */
    public const CLASSKEY_BOOKSTOREHEAD = '\\Propel\\Tests\\Bookstore\\BookstoreHead';

    /** A class that can be returned by this tableMap. */
    public const CLASSNAME_3 = '\\Propel\\Tests\\Bookstore\\BookstoreHead';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'ClassKey', 'Name', 'JobTitle', 'SupervisorId', 'Photo', ],
        self::TYPE_CAMELNAME     => ['id', 'classKey', 'name', 'jobTitle', 'supervisorId', 'photo', ],
        self::TYPE_COLNAME       => [BookstoreEmployeeTableMap::COL_ID, BookstoreEmployeeTableMap::COL_CLASS_KEY, BookstoreEmployeeTableMap::COL_NAME, BookstoreEmployeeTableMap::COL_JOB_TITLE, BookstoreEmployeeTableMap::COL_SUPERVISOR_ID, BookstoreEmployeeTableMap::COL_PHOTO, ],
        self::TYPE_FIELDNAME     => ['id', 'class_key', 'name', 'job_title', 'supervisor_id', 'photo', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'ClassKey' => 1, 'Name' => 2, 'JobTitle' => 3, 'SupervisorId' => 4, 'Photo' => 5, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'classKey' => 1, 'name' => 2, 'jobTitle' => 3, 'supervisorId' => 4, 'photo' => 5, ],
        self::TYPE_COLNAME       => [BookstoreEmployeeTableMap::COL_ID => 0, BookstoreEmployeeTableMap::COL_CLASS_KEY => 1, BookstoreEmployeeTableMap::COL_NAME => 2, BookstoreEmployeeTableMap::COL_JOB_TITLE => 3, BookstoreEmployeeTableMap::COL_SUPERVISOR_ID => 4, BookstoreEmployeeTableMap::COL_PHOTO => 5, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'class_key' => 1, 'name' => 2, 'job_title' => 3, 'supervisor_id' => 4, 'photo' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
    ...
    protected array $normalizedColumnNameMap = [
        'Id' => 'ID',
        'BookstoreEmployee.Id' => 'ID',
        'id' => 'ID',
        'bookstoreEmployee.id' => 'ID',
        'BookstoreEmployeeTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'bookstore_employee.id' => 'ID',
        'ClassKey' => 'CLASS_KEY',
        'BookstoreEmployee.ClassKey' => 'CLASS_KEY',
        'classKey' => 'CLASS_KEY',
        'bookstoreEmployee.classKey' => 'CLASS_KEY',
        'BookstoreEmployeeTableMap::COL_CLASS_KEY' => 'CLASS_KEY',
        'COL_CLASS_KEY' => 'CLASS_KEY',
        'class_key' => 'CLASS_KEY',
        'bookstore_employee.class_key' => 'CLASS_KEY',
        'Name' => 'NAME',
        'BookstoreEmployee.Name' => 'NAME',
        'name' => 'NAME',
        'bookstoreEmployee.name' => 'NAME',
        'BookstoreEmployeeTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'bookstore_employee.name' => 'NAME',
        'JobTitle' => 'JOB_TITLE',
        'BookstoreEmployee.JobTitle' => 'JOB_TITLE',
        'jobTitle' => 'JOB_TITLE',
        'bookstoreEmployee.jobTitle' => 'JOB_TITLE',
        'BookstoreEmployeeTableMap::COL_JOB_TITLE' => 'JOB_TITLE',
        'COL_JOB_TITLE' => 'JOB_TITLE',
        'job_title' => 'JOB_TITLE',
        'bookstore_employee.job_title' => 'JOB_TITLE',
        'SupervisorId' => 'SUPERVISOR_ID',
        'BookstoreEmployee.SupervisorId' => 'SUPERVISOR_ID',
        'supervisorId' => 'SUPERVISOR_ID',
        'bookstoreEmployee.supervisorId' => 'SUPERVISOR_ID',
        'BookstoreEmployeeTableMap::COL_SUPERVISOR_ID' => 'SUPERVISOR_ID',
        'COL_SUPERVISOR_ID' => 'SUPERVISOR_ID',
        'supervisor_id' => 'SUPERVISOR_ID',
        'bookstore_employee.supervisor_id' => 'SUPERVISOR_ID',
        'Photo' => 'PHOTO',
        'BookstoreEmployee.Photo' => 'PHOTO',
        'photo' => 'PHOTO',
        'bookstoreEmployee.photo' => 'PHOTO',
        'BookstoreEmployeeTableMap::COL_PHOTO' => 'PHOTO',
        'COL_PHOTO' => 'PHOTO',
        'bookstore_employee.photo' => 'PHOTO',
    ];
    ...
    {
        $this->addRelation('Supervisor', '\\Propel\\Tests\\Bookstore\\BookstoreEmployee', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':supervisor_id',
    1 => ':id',
        ...
        $this->addRelation('Subordinate', '\\Propel\\Tests\\Bookstore\\BookstoreEmployee', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':supervisor_id',
    1 => ':id',
  ),
), 'SET NULL', null, 'Subordinates', false);
        $this->addRelation('BookstoreEmployeeAccount', '\\Propel\\Tests\\Bookstore\\BookstoreEmployeeAccount', RelationMap::ONE_TO_ONE, array (
  0 =>
  array (
    0 => ':employee_id',
    1 => ':id',
    ...
    public static function getOMClass(array $row, int $colNum, bool $withPrefix = true): string
    {
        try {
            ...
            switch ($classKey) {
                ...
                default:
                    $omClass = $withPrefix
                        ? BookstoreEmployeeTableMap::CLASS_DEFAULT
                        : BookstoreEmployeeTableMap::OM_CLASS;
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(BookstoreEmployeeTableMap::COL_ID);
            $criteria->removeSelectColumn(BookstoreEmployeeTableMap::COL_CLASS_KEY);
            $criteria->removeSelectColumn(BookstoreEmployeeTableMap::COL_NAME);
            $criteria->removeSelectColumn(BookstoreEmployeeTableMap::COL_JOB_TITLE);
            $criteria->removeSelectColumn(BookstoreEmployeeTableMap::COL_SUPERVISOR_ID);
        } else {
            $criteria->removeSelectColumn($alias . '.id');
            $criteria->removeSelectColumn($alias . '.class_key');
            $criteria->removeSelectColumn($alias . '.name');
            $criteria->removeSelectColumn($alias . '.job_title');
            $criteria->removeSelectColumn($alias . '.supervisor_id');
        }
    }
