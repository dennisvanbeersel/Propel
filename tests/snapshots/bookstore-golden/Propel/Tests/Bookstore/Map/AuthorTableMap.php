...
class AuthorTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Propel.Tests.Bookstore.Map.AuthorTableMap';
     ...
     */
    public const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Author';
     ...
     */
    public const COL_EMAIL = 'author.email';

    /**
     * the column name for the age field
     */
    public const COL_AGE = 'author.age';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'FirstName', 'LastName', 'Email', 'Age', ],
        self::TYPE_CAMELNAME     => ['id', 'firstName', 'lastName', 'email', 'age', ],
        self::TYPE_COLNAME       => [AuthorTableMap::COL_ID, AuthorTableMap::COL_FIRST_NAME, AuthorTableMap::COL_LAST_NAME, AuthorTableMap::COL_EMAIL, AuthorTableMap::COL_AGE, ],
        self::TYPE_FIELDNAME     => ['id', 'first_name', 'last_name', 'email', 'age', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'FirstName' => 1, 'LastName' => 2, 'Email' => 3, 'Age' => 4, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'firstName' => 1, 'lastName' => 2, 'email' => 3, 'age' => 4, ],
        self::TYPE_COLNAME       => [AuthorTableMap::COL_ID => 0, AuthorTableMap::COL_FIRST_NAME => 1, AuthorTableMap::COL_LAST_NAME => 2, AuthorTableMap::COL_EMAIL => 3, AuthorTableMap::COL_AGE => 4, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'first_name' => 1, 'last_name' => 2, 'email' => 3, 'age' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected array $normalizedColumnNameMap = [
        ...
        'email' => 'EMAIL',
        'author.email' => 'EMAIL',
        'AuthorTableMap::COL_EMAIL' => 'EMAIL',
        'COL_EMAIL' => 'EMAIL',
        'Age' => 'AGE',
        'Author.Age' => 'AGE',
        'age' => 'AGE',
        'author.age' => 'AGE',
        'AuthorTableMap::COL_AGE' => 'AGE',
        'COL_AGE' => 'AGE',
    ];
    ...
    {
        $this->addRelation('Book', '\\Propel\\Tests\\Bookstore\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
        ...
        $this->addRelation('EssayRelatedByFirstAuthorId', '\\Propel\\Tests\\Bookstore\\Essay', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':first_author_id',
    1 => ':id',
  ),
), 'SET NULL', 'CASCADE', 'EssaysRelatedByFirstAuthorId', false);
        $this->addRelation('EssayRelatedBySecondAuthorId', '\\Propel\\Tests\\Bookstore\\Essay', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':second_author_id',
    1 => ':id',
  ),
), 'SET NULL', 'CASCADE', 'EssaysRelatedBySecondAuthorId', false);
  ...
  array (
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(AuthorTableMap::COL_EMAIL);
            $criteria->removeSelectColumn(AuthorTableMap::COL_AGE);
        } else {
