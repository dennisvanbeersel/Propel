...
class BookReaderTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Propel.Tests.Bookstore.Map.BookReaderTableMap';
     ...
     */
    public const TABLE_NAME = 'book_reader';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'BookReader';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Propel\\Tests\\Bookstore\\BookReader';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Propel.Tests.Bookstore.BookReader';
     ...
     */
    public const COL_ID = 'book_reader.id';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'book_reader.name';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [BookReaderTableMap::COL_ID, BookReaderTableMap::COL_NAME, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [BookReaderTableMap::COL_ID => 0, BookReaderTableMap::COL_NAME => 1, ],
    ...
    protected array $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'bookReader.id' => 'ID',
        'BookReaderTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'book_reader.id' => 'ID',
        'Name' => 'NAME',
        'BookReader.Name' => 'NAME',
        'name' => 'NAME',
        'bookReader.name' => 'NAME',
        'BookReaderTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'book_reader.name' => 'NAME',
    ];
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(BookReaderTableMap::COL_ID);
            $criteria->removeSelectColumn(BookReaderTableMap::COL_NAME);
        } else {
