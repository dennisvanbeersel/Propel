...
class BookListFavoriteTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Propel.Tests.Bookstore.Map.BookListFavoriteTableMap';
     ...
     */
    public const TABLE_NAME = 'book_club_list_favorite_books';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'BookListFavorite';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Propel\\Tests\\Bookstore\\BookListFavorite';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Propel.Tests.Bookstore.BookListFavorite';
     ...
     */
    public const COL_BOOK_ID = 'book_club_list_favorite_books.book_id';

    /**
     * the column name for the book_club_list_id field
     */
    public const COL_BOOK_CLUB_LIST_ID = 'book_club_list_favorite_books.book_club_list_id';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['BookId', 'BookClubListId', ],
        self::TYPE_CAMELNAME     => ['bookId', 'bookClubListId', ],
        self::TYPE_COLNAME       => [BookListFavoriteTableMap::COL_BOOK_ID, BookListFavoriteTableMap::COL_BOOK_CLUB_LIST_ID, ],
        self::TYPE_FIELDNAME     => ['book_id', 'book_club_list_id', ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['BookId' => 0, 'BookClubListId' => 1, ],
        self::TYPE_CAMELNAME     => ['bookId' => 0, 'bookClubListId' => 1, ],
        self::TYPE_COLNAME       => [BookListFavoriteTableMap::COL_BOOK_ID => 0, BookListFavoriteTableMap::COL_BOOK_CLUB_LIST_ID => 1, ],
        self::TYPE_FIELDNAME     => ['book_id' => 0, 'book_club_list_id' => 1, ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected array $normalizedColumnNameMap = [
        'BookId' => 'BOOK_ID',
        'BookListFavorite.BookId' => 'BOOK_ID',
        'bookId' => 'BOOK_ID',
        'bookListFavorite.bookId' => 'BOOK_ID',
        'BookListFavoriteTableMap::COL_BOOK_ID' => 'BOOK_ID',
        'COL_BOOK_ID' => 'BOOK_ID',
        'book_id' => 'BOOK_ID',
        'book_club_list_favorite_books.book_id' => 'BOOK_ID',
        'BookClubListId' => 'BOOK_CLUB_LIST_ID',
        'BookListFavorite.BookClubListId' => 'BOOK_CLUB_LIST_ID',
        'bookClubListId' => 'BOOK_CLUB_LIST_ID',
        'bookListFavorite.bookClubListId' => 'BOOK_CLUB_LIST_ID',
        'BookListFavoriteTableMap::COL_BOOK_CLUB_LIST_ID' => 'BOOK_CLUB_LIST_ID',
        'COL_BOOK_CLUB_LIST_ID' => 'BOOK_CLUB_LIST_ID',
        'book_club_list_id' => 'BOOK_CLUB_LIST_ID',
        'book_club_list_favorite_books.book_club_list_id' => 'BOOK_CLUB_LIST_ID',
    ];
    ...
    {
        $this->addRelation('FavoriteBook', '\\Propel\\Tests\\Bookstore\\Book', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':book_id',
    1 => ':id',
        ...
        $this->addRelation('FavoriteBookClubList', '\\Propel\\Tests\\Bookstore\\BookClubList', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':book_club_list_id',
    1 => ':id',
     ...
     * @return void
     */
    public static function addInstanceToPool(BookListFavorite $obj, ?string $key = null): void
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize([(null === $obj->getBookId() || is_scalar($obj->getBookId()) || is_callable([$obj->getBookId(), '__toString']) ? (string) $obj->getBookId() : $obj->getBookId()), (null === $obj->getBookClubListId() || is_scalar($obj->getBookClubListId()) || is_callable([$obj->getBookClubListId(), '__toString']) ? (string) $obj->getBookClubListId() : $obj->getBookClubListId())]);
            } // if key === null
    ...
    public static function removeInstanceFromPool($value): void
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Propel\Tests\Bookstore\BookListFavorite) {
                $key = serialize([(null === $value->getBookId() || is_scalar($value->getBookId()) || is_callable([$value->getBookId(), '__toString']) ? (string) $value->getBookId() : $value->getBookId()), (null === $value->getBookClubListId() || is_scalar($value->getBookClubListId()) || is_callable([$value->getBookClubListId(), '__toString']) ? (string) $value->getBookClubListId() : $value->getBookClubListId())]);
    ...
    public static function getPrimaryKeyHashFromRow(array $row, int $offset = 0, string $indexType = TableMap::TYPE_NUM): ?string
    {
        ...
        return serialize([(null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('BookId', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('BookId', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('BookId', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('BookId', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('BookId', TableMap::TYPE_PHPNAME, $indexType)]), (null === $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('BookClubListId', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('BookClubListId', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('BookClubListId', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('BookClubListId', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('BookClubListId', TableMap::TYPE_PHPNAME, $indexType)])]);
    }
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(BookListFavoriteTableMap::COL_BOOK_ID);
            $criteria->removeSelectColumn(BookListFavoriteTableMap::COL_BOOK_CLUB_LIST_ID);
        } else {
            $criteria->removeSelectColumn($alias . '.book_id');
            $criteria->removeSelectColumn($alias . '.book_club_list_id');
        }
    }
