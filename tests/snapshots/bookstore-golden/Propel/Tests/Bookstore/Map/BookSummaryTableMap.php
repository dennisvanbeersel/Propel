...
class BookSummaryTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Propel.Tests.Bookstore.Map.BookSummaryTableMap';
     ...
     */
    public const TABLE_NAME = 'book_summary';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'BookSummary';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Propel\\Tests\\Bookstore\\BookSummary';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Propel.Tests.Bookstore.BookSummary';
     ...
     */
    public const COL_ID = 'book_summary.id';

    /**
     * the column name for the book_id field
     */
    public const COL_BOOK_ID = 'book_summary.book_id';

    /**
     * the column name for the summary field
     */
    public const COL_SUMMARY = 'book_summary.summary';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'BookId', 'Summary', ],
        self::TYPE_CAMELNAME     => ['id', 'bookId', 'summary', ],
        self::TYPE_COLNAME       => [BookSummaryTableMap::COL_ID, BookSummaryTableMap::COL_BOOK_ID, BookSummaryTableMap::COL_SUMMARY, ],
        self::TYPE_FIELDNAME     => ['id', 'book_id', 'summary', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'BookId' => 1, 'Summary' => 2, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'bookId' => 1, 'summary' => 2, ],
        self::TYPE_COLNAME       => [BookSummaryTableMap::COL_ID => 0, BookSummaryTableMap::COL_BOOK_ID => 1, BookSummaryTableMap::COL_SUMMARY => 2, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'book_id' => 1, 'summary' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected array $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'bookSummary.id' => 'ID',
        'BookSummaryTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'book_summary.id' => 'ID',
        'BookId' => 'BOOK_ID',
        'BookSummary.BookId' => 'BOOK_ID',
        'bookId' => 'BOOK_ID',
        'bookSummary.bookId' => 'BOOK_ID',
        'BookSummaryTableMap::COL_BOOK_ID' => 'BOOK_ID',
        'COL_BOOK_ID' => 'BOOK_ID',
        'book_id' => 'BOOK_ID',
        'book_summary.book_id' => 'BOOK_ID',
        'Summary' => 'SUMMARY',
        'BookSummary.Summary' => 'SUMMARY',
        'summary' => 'SUMMARY',
        'bookSummary.summary' => 'SUMMARY',
        'BookSummaryTableMap::COL_SUMMARY' => 'SUMMARY',
        'COL_SUMMARY' => 'SUMMARY',
        'book_summary.summary' => 'SUMMARY',
    ];
    ...
    {
        $this->addRelation('SummarizedBook', '\\Propel\\Tests\\Bookstore\\Book', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':book_id',
    1 => ':id',
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(BookSummaryTableMap::COL_ID);
            $criteria->removeSelectColumn(BookSummaryTableMap::COL_BOOK_ID);
            $criteria->removeSelectColumn(BookSummaryTableMap::COL_SUMMARY);
        } else {
