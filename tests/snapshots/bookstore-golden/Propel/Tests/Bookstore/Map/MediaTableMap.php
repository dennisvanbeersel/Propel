...
class MediaTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Propel.Tests.Bookstore.Map.MediaTableMap';
     ...
     */
    public const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Media';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Media';
     ...
     */
    public const NUM_LAZY_LOAD_COLUMNS = 2;
     ...
     */
    public const COL_ID = 'media.id';

    /**
     * the column name for the cover_image field
     */
    public const COL_COVER_IMAGE = 'media.cover_image';

    /**
     * the column name for the excerpt field
     */
    public const COL_EXCERPT = 'media.excerpt';

    /**
     * the column name for the book_id field
     */
    public const COL_BOOK_ID = 'media.book_id';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'CoverImage', 'Excerpt', 'BookId', ],
        self::TYPE_CAMELNAME     => ['id', 'coverImage', 'excerpt', 'bookId', ],
        self::TYPE_COLNAME       => [MediaTableMap::COL_ID, MediaTableMap::COL_COVER_IMAGE, MediaTableMap::COL_EXCERPT, MediaTableMap::COL_BOOK_ID, ],
        self::TYPE_FIELDNAME     => ['id', 'cover_image', 'excerpt', 'book_id', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'CoverImage' => 1, 'Excerpt' => 2, 'BookId' => 3, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'coverImage' => 1, 'excerpt' => 2, 'bookId' => 3, ],
        self::TYPE_COLNAME       => [MediaTableMap::COL_ID => 0, MediaTableMap::COL_COVER_IMAGE => 1, MediaTableMap::COL_EXCERPT => 2, MediaTableMap::COL_BOOK_ID => 3, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'cover_image' => 1, 'excerpt' => 2, 'book_id' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    protected array $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'media.id' => 'ID',
        'MediaTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'CoverImage' => 'COVER_IMAGE',
        'Media.CoverImage' => 'COVER_IMAGE',
        'coverImage' => 'COVER_IMAGE',
        'media.coverImage' => 'COVER_IMAGE',
        'MediaTableMap::COL_COVER_IMAGE' => 'COVER_IMAGE',
        'COL_COVER_IMAGE' => 'COVER_IMAGE',
        ...
        'excerpt' => 'EXCERPT',
        'media.excerpt' => 'EXCERPT',
        'MediaTableMap::COL_EXCERPT' => 'EXCERPT',
        'COL_EXCERPT' => 'EXCERPT',
        'BookId' => 'BOOK_ID',
        'Media.BookId' => 'BOOK_ID',
        'bookId' => 'BOOK_ID',
        'media.bookId' => 'BOOK_ID',
        'MediaTableMap::COL_BOOK_ID' => 'BOOK_ID',
        'COL_BOOK_ID' => 'BOOK_ID',
        'book_id' => 'BOOK_ID',
        'media.book_id' => 'BOOK_ID',
    ];
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(MediaTableMap::COL_ID);
            $criteria->removeSelectColumn(MediaTableMap::COL_BOOK_ID);
        } else {
