...
class CustomerTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Propel.Tests.Bookstore.Map.CustomerTableMap';
     ...
     */
    public const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Customer';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Customer';
     ...
     */
    public const COL_ID = 'customer.id';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'customer.name';

    /**
     * the column name for the join_date field
     */
    public const COL_JOIN_DATE = 'customer.join_date';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Name', 'JoinDate', ],
        self::TYPE_CAMELNAME     => ['id', 'name', 'joinDate', ],
        self::TYPE_COLNAME       => [CustomerTableMap::COL_ID, CustomerTableMap::COL_NAME, CustomerTableMap::COL_JOIN_DATE, ],
        self::TYPE_FIELDNAME     => ['id', 'name', 'join_date', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Name' => 1, 'JoinDate' => 2, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'name' => 1, 'joinDate' => 2, ],
        self::TYPE_COLNAME       => [CustomerTableMap::COL_ID => 0, CustomerTableMap::COL_NAME => 1, CustomerTableMap::COL_JOIN_DATE => 2, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'name' => 1, 'join_date' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected array $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'customer.id' => 'ID',
        'CustomerTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'Name' => 'NAME',
        'Customer.Name' => 'NAME',
        'name' => 'NAME',
        'customer.name' => 'NAME',
        'CustomerTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'JoinDate' => 'JOIN_DATE',
        'Customer.JoinDate' => 'JOIN_DATE',
        'joinDate' => 'JOIN_DATE',
        'customer.joinDate' => 'JOIN_DATE',
        'CustomerTableMap::COL_JOIN_DATE' => 'JOIN_DATE',
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(CustomerTableMap::COL_ID);
            $criteria->removeSelectColumn(CustomerTableMap::COL_NAME);
            $criteria->removeSelectColumn(CustomerTableMap::COL_JOIN_DATE);
        } else {
