...
class ReleasePoolTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Propel.Tests.Bookstore.Map.ReleasePoolTableMap';
     ...
     */
    public const TABLE_NAME = 'release_pool';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'ReleasePool';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Propel\\Tests\\Bookstore\\ReleasePool';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Propel.Tests.Bookstore.ReleasePool';
     ...
     */
    public const COL_ID = 'release_pool.id';

    /**
     * the column name for the record_label_id field
     */
    public const COL_RECORD_LABEL_ID = 'release_pool.record_label_id';

    /**
     * the column name for the record_label_abbr field
     */
    public const COL_RECORD_LABEL_ABBR = 'release_pool.record_label_abbr';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'release_pool.name';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'RecordLabelId', 'RecordLabelAbbr', 'Name', ],
        self::TYPE_CAMELNAME     => ['id', 'recordLabelId', 'recordLabelAbbr', 'name', ],
        self::TYPE_COLNAME       => [ReleasePoolTableMap::COL_ID, ReleasePoolTableMap::COL_RECORD_LABEL_ID, ReleasePoolTableMap::COL_RECORD_LABEL_ABBR, ReleasePoolTableMap::COL_NAME, ],
        self::TYPE_FIELDNAME     => ['id', 'record_label_id', 'record_label_abbr', 'name', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'RecordLabelId' => 1, 'RecordLabelAbbr' => 2, 'Name' => 3, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'recordLabelId' => 1, 'recordLabelAbbr' => 2, 'name' => 3, ],
        self::TYPE_COLNAME       => [ReleasePoolTableMap::COL_ID => 0, ReleasePoolTableMap::COL_RECORD_LABEL_ID => 1, ReleasePoolTableMap::COL_RECORD_LABEL_ABBR => 2, ReleasePoolTableMap::COL_NAME => 3, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'record_label_id' => 1, 'record_label_abbr' => 2, 'name' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    protected array $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'releasePool.id' => 'ID',
        'ReleasePoolTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'release_pool.id' => 'ID',
        'RecordLabelId' => 'RECORD_LABEL_ID',
        'ReleasePool.RecordLabelId' => 'RECORD_LABEL_ID',
        'recordLabelId' => 'RECORD_LABEL_ID',
        'releasePool.recordLabelId' => 'RECORD_LABEL_ID',
        'ReleasePoolTableMap::COL_RECORD_LABEL_ID' => 'RECORD_LABEL_ID',
        'COL_RECORD_LABEL_ID' => 'RECORD_LABEL_ID',
        'record_label_id' => 'RECORD_LABEL_ID',
        'release_pool.record_label_id' => 'RECORD_LABEL_ID',
        'RecordLabelAbbr' => 'RECORD_LABEL_ABBR',
        'ReleasePool.RecordLabelAbbr' => 'RECORD_LABEL_ABBR',
        'recordLabelAbbr' => 'RECORD_LABEL_ABBR',
        'releasePool.recordLabelAbbr' => 'RECORD_LABEL_ABBR',
        'ReleasePoolTableMap::COL_RECORD_LABEL_ABBR' => 'RECORD_LABEL_ABBR',
        'COL_RECORD_LABEL_ABBR' => 'RECORD_LABEL_ABBR',
        'record_label_abbr' => 'RECORD_LABEL_ABBR',
        'release_pool.record_label_abbr' => 'RECORD_LABEL_ABBR',
        'Name' => 'NAME',
        'ReleasePool.Name' => 'NAME',
        'name' => 'NAME',
        'releasePool.name' => 'NAME',
        'ReleasePoolTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'release_pool.name' => 'NAME',
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->addForeignKey('record_label_abbr', 'RecordLabelAbbr', 'VARCHAR', 'record_label', 'abbr', true, 5, null);
    ...
    {
        $this->addRelation('RecordLabel', '\\Propel\\Tests\\Bookstore\\RecordLabel', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':record_label_id',
    1 => ':id',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ReleasePoolTableMap::COL_RECORD_LABEL_ABBR);
            $criteria->addSelectColumn(ReleasePoolTableMap::COL_NAME);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.record_label_id');
            $criteria->addSelectColumn($alias . '.record_label_abbr');
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(ReleasePoolTableMap::COL_ID);
            $criteria->removeSelectColumn(ReleasePoolTableMap::COL_RECORD_LABEL_ID);
            $criteria->removeSelectColumn(ReleasePoolTableMap::COL_RECORD_LABEL_ABBR);
            $criteria->removeSelectColumn(ReleasePoolTableMap::COL_NAME);
        } else {
            $criteria->removeSelectColumn($alias . '.id');
            $criteria->removeSelectColumn($alias . '.record_label_id');
            $criteria->removeSelectColumn($alias . '.record_label_abbr');
