 ...
 *
 * @method     ChildBookstoreEmployeeQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildBookstoreEmployeeQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildBookstoreEmployeeQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 ...
 *
 * @method     ChildBookstoreEmployeeQuery joinWithSupervisor($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Supervisor relation
 *
 * @method     ChildBookstoreEmployeeQuery leftJoinWithSupervisor() Adds a LEFT JOIN clause and with to the query using the Supervisor relation
 * @method     ChildBookstoreEmployeeQuery rightJoinWithSupervisor() Adds a RIGHT JOIN clause and with to the query using the Supervisor relation
 * @method     ChildBookstoreEmployeeQuery innerJoinWithSupervisor() Adds a INNER JOIN clause and with to the query using the Supervisor relation
 *
 ...
 *
 * @method     ChildBookstoreEmployeeQuery joinWithSubordinate($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Subordinate relation
 *
 * @method     ChildBookstoreEmployeeQuery leftJoinWithSubordinate() Adds a LEFT JOIN clause and with to the query using the Subordinate relation
 * @method     ChildBookstoreEmployeeQuery rightJoinWithSubordinate() Adds a RIGHT JOIN clause and with to the query using the Subordinate relation
 * @method     ChildBookstoreEmployeeQuery innerJoinWithSubordinate() Adds a INNER JOIN clause and with to the query using the Subordinate relation
 *
 ...
 *
 * @method     ChildBookstoreEmployeeQuery joinWithBookstoreEmployeeAccount($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookstoreEmployeeAccount relation
 *
 * @method     ChildBookstoreEmployeeQuery leftJoinWithBookstoreEmployeeAccount() Adds a LEFT JOIN clause and with to the query using the BookstoreEmployeeAccount relation
 * @method     ChildBookstoreEmployeeQuery rightJoinWithBookstoreEmployeeAccount() Adds a RIGHT JOIN clause and with to the query using the BookstoreEmployeeAccount relation
 * @method     ChildBookstoreEmployeeQuery innerJoinWithBookstoreEmployeeAccount() Adds a INNER JOIN clause and with to the query using the BookstoreEmployeeAccount relation
 *
 * @method     \Propel\Tests\Bookstore\BookstoreEmployeeQuery|\Propel\Tests\Bookstore\BookstoreEmployeeQuery|\Propel\Tests\Bookstore\BookstoreEmployeeAccountQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildBookstoreEmployee|null findOne(?ConnectionInterface $con = null) Return the first ChildBookstoreEmployee matching the query
 ...
 *
 * @method     ChildBookstoreEmployee|null findOneById(int $id) Return the first ChildBookstoreEmployee filtered by the id column
 * @method     ChildBookstoreEmployee|null findOneByClassKey(int $class_key) Return the first ChildBookstoreEmployee filtered by the class_key column
 * @method     ChildBookstoreEmployee|null findOneByName(string $name) Return the first ChildBookstoreEmployee filtered by the name column
 * @method     ChildBookstoreEmployee|null findOneByJobTitle(string $job_title) Return the first ChildBookstoreEmployee filtered by the job_title column
 * @method     ChildBookstoreEmployee|null findOneBySupervisorId(int $supervisor_id) Return the first ChildBookstoreEmployee filtered by the supervisor_id column
 * @method     ChildBookstoreEmployee|null findOneByPhoto(resource $photo) Return the first ChildBookstoreEmployee filtered by the photo column
 *
 * @method     ChildBookstoreEmployee requirePk($key, ?ConnectionInterface $con = null) Return the ChildBookstoreEmployee by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookstoreEmployee requireOne(?ConnectionInterface $con = null) Return the first ChildBookstoreEmployee matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildBookstoreEmployee requireOneById(int $id) Return the first ChildBookstoreEmployee filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookstoreEmployee requireOneByClassKey(int $class_key) Return the first ChildBookstoreEmployee filtered by the class_key column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookstoreEmployee requireOneByName(string $name) Return the first ChildBookstoreEmployee filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookstoreEmployee requireOneByJobTitle(string $job_title) Return the first ChildBookstoreEmployee filtered by the job_title column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookstoreEmployee requireOneBySupervisorId(int $supervisor_id) Return the first ChildBookstoreEmployee filtered by the supervisor_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookstoreEmployee requireOneByPhoto(resource $photo) Return the first ChildBookstoreEmployee filtered by the photo column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildBookstoreEmployee[]|Collection find(?ConnectionInterface $con = null) Return ChildBookstoreEmployee objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildBookstoreEmployee> find(?ConnectionInterface $con = null) Return ChildBookstoreEmployee objects based on current ModelCriteria
 *
 * @method     ChildBookstoreEmployee[]|Collection findById(int|array<int> $id) Return ChildBookstoreEmployee objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildBookstoreEmployee> findById(int|array<int> $id) Return ChildBookstoreEmployee objects filtered by the id column
 * @method     ChildBookstoreEmployee[]|Collection findByClassKey(int|array<int> $class_key) Return ChildBookstoreEmployee objects filtered by the class_key column
 * @psalm-method Collection&\Traversable<ChildBookstoreEmployee> findByClassKey(int|array<int> $class_key) Return ChildBookstoreEmployee objects filtered by the class_key column
 * @method     ChildBookstoreEmployee[]|Collection findByName(string|array<string> $name) Return ChildBookstoreEmployee objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildBookstoreEmployee> findByName(string|array<string> $name) Return ChildBookstoreEmployee objects filtered by the name column
 * @method     ChildBookstoreEmployee[]|Collection findByJobTitle(string|array<string> $job_title) Return ChildBookstoreEmployee objects filtered by the job_title column
 * @psalm-method Collection&\Traversable<ChildBookstoreEmployee> findByJobTitle(string|array<string> $job_title) Return ChildBookstoreEmployee objects filtered by the job_title column
 * @method     ChildBookstoreEmployee[]|Collection findBySupervisorId(int|array<int> $supervisor_id) Return ChildBookstoreEmployee objects filtered by the supervisor_id column
 * @psalm-method Collection&\Traversable<ChildBookstoreEmployee> findBySupervisorId(int|array<int> $supervisor_id) Return ChildBookstoreEmployee objects filtered by the supervisor_id column
 * @method     ChildBookstoreEmployee[]|Collection findByPhoto(resource|array<resource> $photo) Return ChildBookstoreEmployee objects filtered by the photo column
 * @psalm-method Collection&\Traversable<ChildBookstoreEmployee> findByPhoto(resource|array<resource> $photo) Return ChildBookstoreEmployee objects filtered by the photo column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildBookstoreEmployee> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class BookstoreEmployeeQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Propel\\Tests\\Bookstore\\BookstoreEmployee', ?string $modelAlias = null)
    {
    ...
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = BookstoreEmployeeTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = new $cls();
            $obj->hydrate($row);
            BookstoreEmployeeTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(BookstoreEmployeeTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(BookstoreEmployeeTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookstoreEmployeeTableMap::COL_ID, $id, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByClassKey($classKey = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookstoreEmployeeTableMap::COL_CLASS_KEY, $classKey, $comparison);
    ...
    public function filterByName($name = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookstoreEmployeeTableMap::COL_NAME, $name, $comparison);
    ...
    public function filterByJobTitle($jobTitle = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookstoreEmployeeTableMap::COL_JOB_TITLE, $jobTitle, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySupervisorId($supervisorId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookstoreEmployeeTableMap::COL_SUPERVISOR_ID, $supervisorId, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByPhoto($photo = null, ?string $comparison = null)
    {

        $this->addUsingAlias(BookstoreEmployeeTableMap::COL_PHOTO, $photo, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySupervisor($bookstoreEmployee, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSupervisor(?string $relationAlias = null, ?string $joinType = Criteria::LEFT_JOIN)
    {
     ...
     */
    public function useSupervisorQuery(?string $relationAlias = null, string $joinType = Criteria::LEFT_JOIN)
    {
        return $this
     ...
     * @return $this
     */
    public function withSupervisorQuery(
        callable $callable,
        ?string $relationAlias = null,
        ?string $joinType = Criteria::LEFT_JOIN
    ) {
        $relatedQuery = $this->useSupervisorQuery(
            $relationAlias,
            $joinType
        );
    ...
    /**
     * Use the Supervisor relation to the BookstoreEmployee table for an EXISTS query.
     *
     ...
     */
    public function useSupervisorExistsQuery(?string $modelAlias = null, ?string $queryClass = null, string $typeOfExists = 'EXISTS')
    {
        /** @var $q \Propel\Tests\Bookstore\BookstoreEmployeeQuery */
        $q = $this->useExistsQuery('Supervisor', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the Supervisor relation to the BookstoreEmployee table for a NOT EXISTS query.
     *
     * @see useSupervisorExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     ...
     */
    public function useSupervisorNotExistsQuery(?string $modelAlias = null, ?string $queryClass = null)
    {
        /** @var $q \Propel\Tests\Bookstore\BookstoreEmployeeQuery */
        $q = $this->useExistsQuery('Supervisor', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the Supervisor relation to the BookstoreEmployee table for an IN query.
     *
     ...
     */
    public function useInSupervisorQuery(?string $modelAlias = null, ?string $queryClass = null, string $typeOfIn = 'IN')
    {
        /** @var $q \Propel\Tests\Bookstore\BookstoreEmployeeQuery */
        $q = $this->useInQuery('Supervisor', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the Supervisor relation to the BookstoreEmployee table for a NOT IN query.
     *
     * @see useSupervisorInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     */
    public function useNotInSupervisorQuery(?string $modelAlias = null, ?string $queryClass = null)
    {
        /** @var $q \Propel\Tests\Bookstore\BookstoreEmployeeQuery */
        $q = $this->useInQuery('Supervisor', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySubordinate($bookstoreEmployee, ?string $comparison = null)
    {
        if ($bookstoreEmployee instanceof \Propel\Tests\Bookstore\BookstoreEmployee) {
            $this
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSubordinate(?string $relationAlias = null, ?string $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     * @return \Propel\Tests\Bookstore\BookstoreEmployeeQuery A secondary query class using the current class as primary query
     */
    public function useSubordinateQuery(?string $relationAlias = null, string $joinType = Criteria::LEFT_JOIN)
    {
        return $this
     ...
     * @return $this
     */
    public function withSubordinateQuery(
        callable $callable,
        ?string $relationAlias = null,
        ?string $joinType = Criteria::LEFT_JOIN
    ) {
        $relatedQuery = $this->useSubordinateQuery(
            $relationAlias,
            $joinType
        );
        $callable($relatedQuery);
    ...
    /**
     * Use the Subordinate relation to the BookstoreEmployee table for an EXISTS query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @return \Propel\Tests\Bookstore\BookstoreEmployeeQuery The inner query object of the EXISTS statement
     */
    public function useSubordinateExistsQuery(?string $modelAlias = null, ?string $queryClass = null, string $typeOfExists = 'EXISTS')
    {
        /** @var $q \Propel\Tests\Bookstore\BookstoreEmployeeQuery */
        $q = $this->useExistsQuery('Subordinate', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the Subordinate relation to the BookstoreEmployee table for a NOT EXISTS query.
     *
     * @see useSubordinateExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \Propel\Tests\Bookstore\BookstoreEmployeeQuery The inner query object of the NOT EXISTS statement
     */
    public function useSubordinateNotExistsQuery(?string $modelAlias = null, ?string $queryClass = null)
    {
        /** @var $q \Propel\Tests\Bookstore\BookstoreEmployeeQuery */
        $q = $this->useExistsQuery('Subordinate', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the Subordinate relation to the BookstoreEmployee table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @return \Propel\Tests\Bookstore\BookstoreEmployeeQuery The inner query object of the IN statement
     */
    public function useInSubordinateQuery(?string $modelAlias = null, ?string $queryClass = null, string $typeOfIn = 'IN')
    {
        /** @var $q \Propel\Tests\Bookstore\BookstoreEmployeeQuery */
        $q = $this->useInQuery('Subordinate', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the Subordinate relation to the BookstoreEmployee table for a NOT IN query.
     *
     * @see useSubordinateInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Propel\Tests\Bookstore\BookstoreEmployeeQuery The inner query object of the NOT IN statement
     */
    public function useNotInSubordinateQuery(?string $modelAlias = null, ?string $queryClass = null)
    {
        /** @var $q \Propel\Tests\Bookstore\BookstoreEmployeeQuery */
        $q = $this->useInQuery('Subordinate', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
