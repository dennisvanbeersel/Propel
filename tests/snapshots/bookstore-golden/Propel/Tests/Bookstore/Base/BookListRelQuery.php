 ...
 *
 * @method     ChildBookListRelQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildBookListRelQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildBookListRelQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 ...
 *
 * @method     ChildBookListRelQuery joinWithBook($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Book relation
 *
 * @method     ChildBookListRelQuery leftJoinWithBook() Adds a LEFT JOIN clause and with to the query using the Book relation
 * @method     ChildBookListRelQuery rightJoinWithBook() Adds a RIGHT JOIN clause and with to the query using the Book relation
 * @method     ChildBookListRelQuery innerJoinWithBook() Adds a INNER JOIN clause and with to the query using the Book relation
 *
 ...
 *
 * @method     ChildBookListRelQuery joinWithBookClubList($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookClubList relation
 *
 * @method     ChildBookListRelQuery leftJoinWithBookClubList() Adds a LEFT JOIN clause and with to the query using the BookClubList relation
 * @method     ChildBookListRelQuery rightJoinWithBookClubList() Adds a RIGHT JOIN clause and with to the query using the BookClubList relation
 * @method     ChildBookListRelQuery innerJoinWithBookClubList() Adds a INNER JOIN clause and with to the query using the BookClubList relation
 *
 ...
 *
 * @method     ChildBookListRel|null findOne(?ConnectionInterface $con = null) Return the first ChildBookListRel matching the query
 ...
 *
 * @method     ChildBookListRel|null findOneByBookId(int $book_id) Return the first ChildBookListRel filtered by the book_id column
 * @method     ChildBookListRel|null findOneByBookClubListId(int $book_club_list_id) Return the first ChildBookListRel filtered by the book_club_list_id column
 *
 * @method     ChildBookListRel requirePk($key, ?ConnectionInterface $con = null) Return the ChildBookListRel by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookListRel requireOne(?ConnectionInterface $con = null) Return the first ChildBookListRel matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildBookListRel requireOneByBookId(int $book_id) Return the first ChildBookListRel filtered by the book_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookListRel requireOneByBookClubListId(int $book_club_list_id) Return the first ChildBookListRel filtered by the book_club_list_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildBookListRel[]|Collection find(?ConnectionInterface $con = null) Return ChildBookListRel objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildBookListRel> find(?ConnectionInterface $con = null) Return ChildBookListRel objects based on current ModelCriteria
 *
 * @method     ChildBookListRel[]|Collection findByBookId(int|array<int> $book_id) Return ChildBookListRel objects filtered by the book_id column
 * @psalm-method Collection&\Traversable<ChildBookListRel> findByBookId(int|array<int> $book_id) Return ChildBookListRel objects filtered by the book_id column
 * @method     ChildBookListRel[]|Collection findByBookClubListId(int|array<int> $book_club_list_id) Return ChildBookListRel objects filtered by the book_club_list_id column
 * @psalm-method Collection&\Traversable<ChildBookListRel> findByBookClubListId(int|array<int> $book_club_list_id) Return ChildBookListRel objects filtered by the book_club_list_id column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildBookListRel> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class BookListRelQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Propel\\Tests\\Bookstore\\BookListRel', ?string $modelAlias = null)
    {
    ...
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = BookListRelTableMap::getInstanceFromPool(serialize([(null === $key[0] || is_scalar($key[0]) || is_callable([$key[0], '__toString']) ? (string) $key[0] : $key[0]), (null === $key[1] || is_scalar($key[1]) || is_callable([$key[1], '__toString']) ? (string) $key[1] : $key[1])]))))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            BookListRelTableMap::addInstanceToPool($obj, serialize([(null === $key[0] || is_scalar($key[0]) || is_callable([$key[0], '__toString']) ? (string) $key[0] : $key[0]), (null === $key[1] || is_scalar($key[1]) || is_callable([$key[1], '__toString']) ? (string) $key[1] : $key[1])]));
        }
        $stmt->closeCursor();
    ...
    public function filterByBookId($bookId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookListRelTableMap::COL_BOOK_ID, $bookId, $comparison);
    ...
    public function filterByBookClubListId($bookClubListId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookListRelTableMap::COL_BOOK_CLUB_LIST_ID, $bookClubListId, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinBookClubList(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     */
    public function useBookClubListQuery(?string $relationAlias = null, string $joinType = Criteria::INNER_JOIN)
    {
        return $this
     ...
     * @return $this
     */
    public function withBookClubListQuery(
        callable $callable,
        ?string $relationAlias = null,
        ?string $joinType = Criteria::INNER_JOIN
    ) {
        $relatedQuery = $this->useBookClubListQuery(
            $relationAlias,
            $joinType
        );
        $callable($relatedQuery);
    ...
    /**
     * Use the relation to BookClubList table for an EXISTS query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     */
    public function useBookClubListExistsQuery(?string $modelAlias = null, ?string $queryClass = null, string $typeOfExists = 'EXISTS')
    {
        /** @var $q \Propel\Tests\Bookstore\BookClubListQuery */
        $q = $this->useExistsQuery('BookClubList', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the relation to BookClubList table for a NOT EXISTS query.
     *
     * @see useBookClubListExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     ...
     */
    public function useBookClubListNotExistsQuery(?string $modelAlias = null, ?string $queryClass = null)
    {
        /** @var $q \Propel\Tests\Bookstore\BookClubListQuery */
        $q = $this->useExistsQuery('BookClubList', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the relation to BookClubList table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     */
    public function useInBookClubListQuery(?string $modelAlias = null, ?string $queryClass = null, string $typeOfIn = 'IN')
    {
        /** @var $q \Propel\Tests\Bookstore\BookClubListQuery */
        $q = $this->useInQuery('BookClubList', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the relation to BookClubList table for a NOT IN query.
     *
     * @see useBookClubListInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     ...
     */
    public function useNotInBookClubListQuery(?string $modelAlias = null, ?string $queryClass = null)
    {
        /** @var $q \Propel\Tests\Bookstore\BookClubListQuery */
        $q = $this->useInQuery('BookClubList', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
