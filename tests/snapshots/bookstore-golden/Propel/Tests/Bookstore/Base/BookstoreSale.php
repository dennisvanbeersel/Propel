...
abstract class BookstoreSale implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\BookstoreSaleTableMap';
     ...
     * @var        int|null
     */
    public protected(set) ?int $publisher_id = null;
     ...
     * @var        string|null
     */
    public protected(set) ?string $sale_name = null;
     ...
     * @var        int|null
     */
    public protected(set) ?int $discount = null;
    ...
    {
        $pos = (int)BookstoreSaleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BookstoreSale'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['BookstoreSale'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildBookstoreSaleQuery::create();
        $criteria->add(BookstoreSaleTableMap::COL_ID, $this->id);
