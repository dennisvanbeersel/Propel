...
abstract class Customer implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\CustomerTableMap';
     ...
     */
    public function getJoinDate(?string $format = null)
    {
        if ($format === null) {
    ...
    {
        $pos = (int)CustomerTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
