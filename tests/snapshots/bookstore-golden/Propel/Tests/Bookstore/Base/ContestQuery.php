 ...
 * @method     ChildContestQuery orderByCountryCode($order = Criteria::ASC) Order by the country_code column
 *
 * @method     ChildContestQuery groupById() Group by the id column
 * @method     ChildContestQuery groupByName() Group by the name column
 * @method     ChildContestQuery groupByCountryCode() Group by the country_code column
 *
 ...
 *
 * @method     ChildContestQuery leftJoinCountry($relationAlias = null) Adds a LEFT JOIN clause to the query using the Country relation
 * @method     ChildContestQuery rightJoinCountry($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Country relation
 * @method     ChildContestQuery innerJoinCountry($relationAlias = null) Adds a INNER JOIN clause to the query using the Country relation
 *
 * @method     ChildContestQuery joinWithCountry($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Country relation
 *
 * @method     ChildContestQuery leftJoinWithCountry() Adds a LEFT JOIN clause and with to the query using the Country relation
 * @method     ChildContestQuery rightJoinWithCountry() Adds a RIGHT JOIN clause and with to the query using the Country relation
 * @method     ChildContestQuery innerJoinWithCountry() Adds a INNER JOIN clause and with to the query using the Country relation
 *
 ...
 *
 * @method     ChildContestQuery joinWithBookstoreContest($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookstoreContest relation
 *
 * @method     ChildContestQuery leftJoinWithBookstoreContest() Adds a LEFT JOIN clause and with to the query using the BookstoreContest relation
 * @method     ChildContestQuery rightJoinWithBookstoreContest() Adds a RIGHT JOIN clause and with to the query using the BookstoreContest relation
 * @method     ChildContestQuery innerJoinWithBookstoreContest() Adds a INNER JOIN clause and with to the query using the BookstoreContest relation
 *
 * @method     \Propel\Tests\Bookstore\CountryQuery|\Propel\Tests\Bookstore\BookstoreContestQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildContest|null findOne(?ConnectionInterface $con = null) Return the first ChildContest matching the query
 ...
 *
 * @method     ChildContest|null findOneById(int $id) Return the first ChildContest filtered by the id column
 * @method     ChildContest|null findOneByName(string $name) Return the first ChildContest filtered by the name column
 * @method     ChildContest|null findOneByCountryCode(string $country_code) Return the first ChildContest filtered by the country_code column
 *
 ...
 *
 * @method     ChildContest requireOneById(int $id) Return the first ChildContest filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildContest requireOneByName(string $name) Return the first ChildContest filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildContest requireOneByCountryCode(string $country_code) Return the first ChildContest filtered by the country_code column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildContest[]|Collection find(?ConnectionInterface $con = null) Return ChildContest objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildContest> find(?ConnectionInterface $con = null) Return ChildContest objects based on current ModelCriteria
 *
 * @method     ChildContest[]|Collection findById(int|array<int> $id) Return ChildContest objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildContest> findById(int|array<int> $id) Return ChildContest objects filtered by the id column
 * @method     ChildContest[]|Collection findByName(string|array<string> $name) Return ChildContest objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildContest> findByName(string|array<string> $name) Return ChildContest objects filtered by the name column
 * @method     ChildContest[]|Collection findByCountryCode(string|array<string> $country_code) Return ChildContest objects filtered by the country_code column
 * @psalm-method Collection&\Traversable<ChildContest> findByCountryCode(string|array<string> $country_code) Return ChildContest objects filtered by the country_code column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildContest> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class ContestQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Propel\\Tests\\Bookstore\\Contest', ?string $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, country_code FROM contest WHERE id = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(ContestTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(ContestTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ContestTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByName($name = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ContestTableMap::COL_NAME, $name, $comparison);
    ...
    public function filterByCountryCode($countryCode = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ContestTableMap::COL_COUNTRY_CODE, $countryCode, $comparison);
    ...
    public function filterByCountry($country, ?string $comparison = null)
    {
        if ($country instanceof \Propel\Tests\Bookstore\Country) {
            return $this
                ->addUsingAlias(ContestTableMap::COL_COUNTRY_CODE, $country->getCode(), $comparison);
            ...
            $this
                ->addUsingAlias(ContestTableMap::COL_COUNTRY_CODE, $country->toKeyValue('PrimaryKey', 'Code'), $comparison);
