 ...
 *
 * @method     ChildBookClubListQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 * @method     ChildBookClubListQuery rightJoinWith($relation) Adds a RIGHT JOIN clause and with to the query
 * @method     ChildBookClubListQuery innerJoinWith($relation) Adds a INNER JOIN clause and with to the query
 *
 ...
 *
 * @method     ChildBookClubListQuery joinWithBookListRel($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookListRel relation
 *
 * @method     ChildBookClubListQuery leftJoinWithBookListRel() Adds a LEFT JOIN clause and with to the query using the BookListRel relation
 * @method     ChildBookClubListQuery rightJoinWithBookListRel() Adds a RIGHT JOIN clause and with to the query using the BookListRel relation
 * @method     ChildBookClubListQuery innerJoinWithBookListRel() Adds a INNER JOIN clause and with to the query using the BookListRel relation
 *
 ...
 *
 * @method     ChildBookClubListQuery joinWithBookListFavorite($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookListFavorite relation
 *
 * @method     ChildBookClubListQuery leftJoinWithBookListFavorite() Adds a LEFT JOIN clause and with to the query using the BookListFavorite relation
 * @method     ChildBookClubListQuery rightJoinWithBookListFavorite() Adds a RIGHT JOIN clause and with to the query using the BookListFavorite relation
 * @method     ChildBookClubListQuery innerJoinWithBookListFavorite() Adds a INNER JOIN clause and with to the query using the BookListFavorite relation
 *
 ...
 *
 * @method     ChildBookClubList|null findOne(?ConnectionInterface $con = null) Return the first ChildBookClubList matching the query
 ...
 *
 * @method     ChildBookClubList|null findOneById(int $id) Return the first ChildBookClubList filtered by the id column
 * @method     ChildBookClubList|null findOneByGroupLeader(string $group_leader) Return the first ChildBookClubList filtered by the group_leader column
 * @method     ChildBookClubList|null findOneByTheme(string $theme) Return the first ChildBookClubList filtered by the theme column
 * @method     ChildBookClubList|null findOneByCreatedAt(string $created_at) Return the first ChildBookClubList filtered by the created_at column
 *
 * @method     ChildBookClubList requirePk($key, ?ConnectionInterface $con = null) Return the ChildBookClubList by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookClubList requireOne(?ConnectionInterface $con = null) Return the first ChildBookClubList matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildBookClubList requireOneById(int $id) Return the first ChildBookClubList filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookClubList requireOneByGroupLeader(string $group_leader) Return the first ChildBookClubList filtered by the group_leader column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookClubList requireOneByTheme(string $theme) Return the first ChildBookClubList filtered by the theme column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookClubList requireOneByCreatedAt(string $created_at) Return the first ChildBookClubList filtered by the created_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildBookClubList[]|Collection find(?ConnectionInterface $con = null) Return ChildBookClubList objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildBookClubList> find(?ConnectionInterface $con = null) Return ChildBookClubList objects based on current ModelCriteria
 *
 * @method     ChildBookClubList[]|Collection findById(int|array<int> $id) Return ChildBookClubList objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildBookClubList> findById(int|array<int> $id) Return ChildBookClubList objects filtered by the id column
 * @method     ChildBookClubList[]|Collection findByGroupLeader(string|array<string> $group_leader) Return ChildBookClubList objects filtered by the group_leader column
 * @psalm-method Collection&\Traversable<ChildBookClubList> findByGroupLeader(string|array<string> $group_leader) Return ChildBookClubList objects filtered by the group_leader column
 * @method     ChildBookClubList[]|Collection findByTheme(string|array<string> $theme) Return ChildBookClubList objects filtered by the theme column
 * @psalm-method Collection&\Traversable<ChildBookClubList> findByTheme(string|array<string> $theme) Return ChildBookClubList objects filtered by the theme column
 * @method     ChildBookClubList[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildBookClubList objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildBookClubList> findByCreatedAt(string|array<string> $created_at) Return ChildBookClubList objects filtered by the created_at column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildBookClubList> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class BookClubListQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Propel\\Tests\\Bookstore\\BookClubList', ?string $modelAlias = null)
    {
    ...
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = BookClubListTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            BookClubListTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(BookClubListTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(BookClubListTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookClubListTableMap::COL_ID, $id, $comparison);
     ...
     * $query->filterByGroupLeader('%fooValue%', Criteria::LIKE); // WHERE group_leader LIKE '%fooValue%'
     * $query->filterByGroupLeader(['foo', 'bar']); // WHERE group_leader IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $groupLeader The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByGroupLeader($groupLeader = null, ?string $comparison = null)
    {
        if (null === $comparison) {
        ...
        $this->addUsingAlias(BookClubListTableMap::COL_GROUP_LEADER, $groupLeader, $comparison);
    ...
    public function filterByTheme($theme = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookClubListTableMap::COL_THEME, $theme, $comparison);
    ...
    public function filterByCreatedAt($createdAt = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookClubListTableMap::COL_CREATED_AT, $createdAt, $comparison);
