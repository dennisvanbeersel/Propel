 ...
 *
 * @method     ChildBookstoreQuery joinWithBookstoreSale($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookstoreSale relation
 *
 * @method     ChildBookstoreQuery leftJoinWithBookstoreSale() Adds a LEFT JOIN clause and with to the query using the BookstoreSale relation
 * @method     ChildBookstoreQuery rightJoinWithBookstoreSale() Adds a RIGHT JOIN clause and with to the query using the BookstoreSale relation
 * @method     ChildBookstoreQuery innerJoinWithBookstoreSale() Adds a INNER JOIN clause and with to the query using the BookstoreSale relation
 *
 ...
 *
 * @method     ChildBookstoreQuery joinWithBookstoreContest($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookstoreContest relation
 *
 * @method     ChildBookstoreQuery leftJoinWithBookstoreContest() Adds a LEFT JOIN clause and with to the query using the BookstoreContest relation
 * @method     ChildBookstoreQuery rightJoinWithBookstoreContest() Adds a RIGHT JOIN clause and with to the query using the BookstoreContest relation
 * @method     ChildBookstoreQuery innerJoinWithBookstoreContest() Adds a INNER JOIN clause and with to the query using the BookstoreContest relation
 *
 ...
 *
 * @method     ChildBookstoreQuery joinWithBookstoreContestEntry($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookstoreContestEntry relation
 *
 * @method     ChildBookstoreQuery leftJoinWithBookstoreContestEntry() Adds a LEFT JOIN clause and with to the query using the BookstoreContestEntry relation
 * @method     ChildBookstoreQuery rightJoinWithBookstoreContestEntry() Adds a RIGHT JOIN clause and with to the query using the BookstoreContestEntry relation
 * @method     ChildBookstoreQuery innerJoinWithBookstoreContestEntry() Adds a INNER JOIN clause and with to the query using the BookstoreContestEntry relation
 *
 ...
 *
 * @method     ChildBookstore|null findOne(?ConnectionInterface $con = null) Return the first ChildBookstore matching the query
 ...
 *
 * @method     ChildBookstore|null findOneById(int $id) Return the first ChildBookstore filtered by the id column
 * @method     ChildBookstore|null findOneByStoreName(string $store_name) Return the first ChildBookstore filtered by the store_name column
 * @method     ChildBookstore|null findOneByLocation(string $location) Return the first ChildBookstore filtered by the location column
 * @method     ChildBookstore|null findOneByPopulationServed(string $population_served) Return the first ChildBookstore filtered by the population_served column
 * @method     ChildBookstore|null findOneByTotalBooks(int $total_books) Return the first ChildBookstore filtered by the total_books column
 * @method     ChildBookstore|null findOneByStoreOpenTime(string $store_open_time) Return the first ChildBookstore filtered by the store_open_time column
 * @method     ChildBookstore|null findOneByWebsite(string $website) Return the first ChildBookstore filtered by the website column
 *
 ...
 * @method     ChildBookstore requireOneByStoreName(string $store_name) Return the first ChildBookstore filtered by the store_name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookstore requireOneByLocation(string $location) Return the first ChildBookstore filtered by the location column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookstore requireOneByPopulationServed(string $population_served) Return the first ChildBookstore filtered by the population_served column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookstore requireOneByTotalBooks(int $total_books) Return the first ChildBookstore filtered by the total_books column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookstore requireOneByStoreOpenTime(string $store_open_time) Return the first ChildBookstore filtered by the store_open_time column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildBookstore requireOneByWebsite(string $website) Return the first ChildBookstore filtered by the website column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildBookstore[]|Collection find(?ConnectionInterface $con = null) Return ChildBookstore objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildBookstore> find(?ConnectionInterface $con = null) Return ChildBookstore objects based on current ModelCriteria
 *
 * @method     ChildBookstore[]|Collection findById(int|array<int> $id) Return ChildBookstore objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildBookstore> findById(int|array<int> $id) Return ChildBookstore objects filtered by the id column
 * @method     ChildBookstore[]|Collection findByStoreName(string|array<string> $store_name) Return ChildBookstore objects filtered by the store_name column
 * @psalm-method Collection&\Traversable<ChildBookstore> findByStoreName(string|array<string> $store_name) Return ChildBookstore objects filtered by the store_name column
 * @method     ChildBookstore[]|Collection findByLocation(string|array<string> $location) Return ChildBookstore objects filtered by the location column
 * @psalm-method Collection&\Traversable<ChildBookstore> findByLocation(string|array<string> $location) Return ChildBookstore objects filtered by the location column
 * @method     ChildBookstore[]|Collection findByPopulationServed(string|array<string> $population_served) Return ChildBookstore objects filtered by the population_served column
 * @psalm-method Collection&\Traversable<ChildBookstore> findByPopulationServed(string|array<string> $population_served) Return ChildBookstore objects filtered by the population_served column
 * @method     ChildBookstore[]|Collection findByTotalBooks(int|array<int> $total_books) Return ChildBookstore objects filtered by the total_books column
 * @psalm-method Collection&\Traversable<ChildBookstore> findByTotalBooks(int|array<int> $total_books) Return ChildBookstore objects filtered by the total_books column
 * @method     ChildBookstore[]|Collection findByStoreOpenTime(string|array<string> $store_open_time) Return ChildBookstore objects filtered by the store_open_time column
 * @psalm-method Collection&\Traversable<ChildBookstore> findByStoreOpenTime(string|array<string> $store_open_time) Return ChildBookstore objects filtered by the store_open_time column
 * @method     ChildBookstore[]|Collection findByWebsite(string|array<string> $website) Return ChildBookstore objects filtered by the website column
 * @psalm-method Collection&\Traversable<ChildBookstore> findByWebsite(string|array<string> $website) Return ChildBookstore objects filtered by the website column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildBookstore> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class BookstoreQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Propel\\Tests\\Bookstore\\Bookstore', ?string $modelAlias = null)
    {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(BookstoreTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(BookstoreTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookstoreTableMap::COL_ID, $id, $comparison);
     ...
     * $query->filterByStoreName(['foo', 'bar']); // WHERE store_name IN ('foo', 'bar')
     * </code>
     *
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByStoreName($storeName = null, ?string $comparison = null)
    {
        if (null === $comparison) {
        ...
        $this->addUsingAlias(BookstoreTableMap::COL_STORE_NAME, $storeName, $comparison);
    ...
    public function filterByLocation($location = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookstoreTableMap::COL_LOCATION, $location, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByPopulationServed($populationServed = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookstoreTableMap::COL_POPULATION_SERVED, $populationServed, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByTotalBooks($totalBooks = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookstoreTableMap::COL_TOTAL_BOOKS, $totalBooks, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByStoreOpenTime($storeOpenTime = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookstoreTableMap::COL_STORE_OPEN_TIME, $storeOpenTime, $comparison);
    ...
    public function filterByWebsite($website = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(BookstoreTableMap::COL_WEBSITE, $website, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByBookstoreSale($bookstoreSale, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinBookstoreSale(?string $relationAlias = null, ?string $joinType = Criteria::LEFT_JOIN)
    {
     ...
     */
    public function useBookstoreSaleQuery(?string $relationAlias = null, string $joinType = Criteria::LEFT_JOIN)
    {
        return $this
     ...
     * Use the BookstoreSale relation BookstoreSale object
     *
     * @param callable(\Propel\Tests\Bookstore\BookstoreSaleQuery):\Propel\Tests\Bookstore\BookstoreSaleQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @return $this
     */
    public function withBookstoreSaleQuery(
        callable $callable,
        ?string $relationAlias = null,
        ?string $joinType = Criteria::LEFT_JOIN
    ) {
        $relatedQuery = $this->useBookstoreSaleQuery(
            $relationAlias,
            $joinType
        );
    ...
    /**
     * Use the relation to BookstoreSale table for an EXISTS query.
     *
     ...
     *
     * @return \Propel\Tests\Bookstore\BookstoreSaleQuery The inner query object of the EXISTS statement
     */
    public function useBookstoreSaleExistsQuery(?string $modelAlias = null, ?string $queryClass = null, string $typeOfExists = 'EXISTS')
    {
        /** @var $q \Propel\Tests\Bookstore\BookstoreSaleQuery */
        $q = $this->useExistsQuery('BookstoreSale', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the relation to BookstoreSale table for a NOT EXISTS query.
     *
     * @see useBookstoreSaleExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \Propel\Tests\Bookstore\BookstoreSaleQuery The inner query object of the NOT EXISTS statement
     */
    public function useBookstoreSaleNotExistsQuery(?string $modelAlias = null, ?string $queryClass = null)
    {
        /** @var $q \Propel\Tests\Bookstore\BookstoreSaleQuery */
        $q = $this->useExistsQuery('BookstoreSale', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the relation to BookstoreSale table for an IN query.
     *
     ...
     *
     * @return \Propel\Tests\Bookstore\BookstoreSaleQuery The inner query object of the IN statement
     */
    public function useInBookstoreSaleQuery(?string $modelAlias = null, ?string $queryClass = null, string $typeOfIn = 'IN')
    {
        /** @var $q \Propel\Tests\Bookstore\BookstoreSaleQuery */
        $q = $this->useInQuery('BookstoreSale', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the relation to BookstoreSale table for a NOT IN query.
     *
     * @see useBookstoreSaleInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Propel\Tests\Bookstore\BookstoreSaleQuery The inner query object of the NOT IN statement
     */
    public function useNotInBookstoreSaleQuery(?string $modelAlias = null, ?string $queryClass = null)
    {
        /** @var $q \Propel\Tests\Bookstore\BookstoreSaleQuery */
        $q = $this->useInQuery('BookstoreSale', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
