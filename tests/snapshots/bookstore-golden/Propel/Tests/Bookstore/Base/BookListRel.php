...
abstract class BookListRel implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\BookListRelTableMap';
    ...
    {
        $pos = (int)BookListRelTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BookListRel'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['BookListRel'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildBookListRelQuery::create();
        $criteria->add(BookListRelTableMap::COL_BOOK_ID, $this->book_id);
        $criteria->add(BookListRelTableMap::COL_BOOK_CLUB_LIST_ID, $this->book_club_list_id);
