...
abstract class Woman implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\WomanTableMap';
     ...
     * @var        int|null
     */
    public protected(set) ?int $husband_id = null;

    /**
     * @var        ChildMan|null
     */
    protected ?ChildMan $aManRelatedByHusbandId = null;

    /**
     * @var        ObjectCollection|ChildMan[] Collection to store aggregation of ChildMan objects.
     * @phpstan-var ObjectCollection&\Traversable<ChildMan> Collection to store aggregation of ChildMan objects.
     */
    protected $collMenRelatedByWifeId;
    protected bool $collMenRelatedByWifeIdPartial = false;
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildMan>
     */
    ...
    {
        $pos = (int)WomanTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Woman'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Woman'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildWomanQuery::create();
        $criteria->add(WomanTableMap::COL_ID, $this->id);
     ...
     *
     * @param ChildMan|null $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setManRelatedByHusbandId(?ChildMan $v = null): self
    {
        if ($v === null) {
     ...
     * @return ChildMan|null The associated ChildMan object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getManRelatedByHusbandId(?ConnectionInterface $con = null): ?ChildMan
    {
     ...
     * @return void
     */
    public function resetPartialMenRelatedByWifeId($v = true): void
    {
     ...
     * @return void
     */
    public function initMenRelatedByWifeId(bool $overrideExisting = true): void
    {
        if (null !== $this->collMenRelatedByWifeId && !$overrideExisting) {
            return;
        }

        $collectionClassName = ManTableMap::getTableMap()->getCollectionClassName();

        $this->collMenRelatedByWifeId = new $collectionClassName;
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildMan> List of ChildMan objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collMenRelatedByWifeId || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collMenRelatedByWifeId) {
                    ...
                    $collMenRelatedByWifeId = new $collectionClassName;
                    $collMenRelatedByWifeId->setModel('\Propel\Tests\Bookstore\Man');
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countMenRelatedByWifeId(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collMenRelatedByWifeIdPartial && !$this->isNew();
        if (null === $this->collMenRelatedByWifeId || null !== $criteria || $partial) {
    ...
    public function addManRelatedByWifeId(ChildMan $l)
    {
        ...
        if (!$this->collMenRelatedByWifeId->contains($l)) {
            ...
            if ($this->menRelatedByWifeIdScheduledForDeletion and $this->menRelatedByWifeIdScheduledForDeletion->contains($l)) {
                $this->menRelatedByWifeIdScheduledForDeletion->remove($this->menRelatedByWifeIdScheduledForDeletion->search($l));
            }
        }
     ...
     */
    protected function doAddManRelatedByWifeId(ChildMan $manRelatedByWifeId): void
    {
