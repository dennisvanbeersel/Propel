...
abstract class BookstoreContestEntry implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\BookstoreContestEntryTableMap';
     ...
     */
    public function getEntryDate(?string $format = null)
    {
        if ($format === null) {
    ...
    {
        $pos = (int)BookstoreContestEntryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BookstoreContestEntry'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['BookstoreContestEntry'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildBookstoreContestEntryQuery::create();
        $criteria->add(BookstoreContestEntryTableMap::COL_BOOKSTORE_ID, $this->bookstore_id);
        $criteria->add(BookstoreContestEntryTableMap::COL_CONTEST_ID, $this->contest_id);
        $criteria->add(BookstoreContestEntryTableMap::COL_CUSTOMER_ID, $this->customer_id);
