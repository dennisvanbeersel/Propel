...
abstract class BookstoreContest implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\BookstoreContestTableMap';
     ...
     * @var        int|null
     */
    public protected(set) ?int $prize_book_id = null;
    ...
    {
        $pos = (int)BookstoreContestTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BookstoreContest'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['BookstoreContest'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildBookstoreContestQuery::create();
        $criteria->add(BookstoreContestTableMap::COL_BOOKSTORE_ID, $this->bookstore_id);
        $criteria->add(BookstoreContestTableMap::COL_CONTEST_ID, $this->contest_id);
