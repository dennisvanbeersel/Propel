 ...
 *
 * @method     ChildPublisherQuery joinWithBookstoreSale($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BookstoreSale relation
 *
 * @method     ChildPublisherQuery leftJoinWithBookstoreSale() Adds a LEFT JOIN clause and with to the query using the BookstoreSale relation
 * @method     ChildPublisherQuery rightJoinWithBookstoreSale() Adds a RIGHT JOIN clause and with to the query using the BookstoreSale relation
 * @method     ChildPublisherQuery innerJoinWithBookstoreSale() Adds a INNER JOIN clause and with to the query using the BookstoreSale relation
 *
...
abstract class PublisherQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Propel\\Tests\\Bookstore\\Publisher', ?string $modelAlias = null)
    {
