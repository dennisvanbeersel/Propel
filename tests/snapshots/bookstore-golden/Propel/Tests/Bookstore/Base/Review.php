...
abstract class Review implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\ReviewTableMap';
     ...
     * @var        string
     */
    public protected(set) ?string $reviewed_by = null;
     ...
     * @var        bool
     */
    public protected(set) ?bool $recommended = null;
     ...
     */
    public function getReviewDate(?string $format = null)
    {
        if ($format === null) {
            return $this->review_date;
        } else {
            return $this->review_date instanceof \DateTimeInterface ? $this->review_date->format($format) : null;
        }
    }
    ...
    public function setReviewDate($v): self
    {
        ...
        if ($this->review_date !== null || $dt !== null) {
            if ( ($dt != $this->review_date) // normalized values don't match
                ...
                $this->review_date = $dt === null ? null : clone $dt;
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'reviewed_by':
                        ...
                        break;
                    case 'review_date':
                        $stmt->bindValue($identifier, $this->review_date ? $this->review_date->format("Y-m-d") : null, PDO::PARAM_STR);
