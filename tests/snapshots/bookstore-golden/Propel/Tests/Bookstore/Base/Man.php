...
abstract class Man implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\ManTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildWoman>
     */
     ...
     * @return $this The current object (for fluent API support)
     */
    public function setWifeId($v): self
    {
        if ($v !== null) {
            $v = (int) $v;
        }
    ...
    {
        $pos = (int)ManTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Man'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Man'][$this->hashCode()] = true;
     ...
     * @return void
     */
    public function resetPartialWomenRelatedByHusbandId($v = true): void
    {
     ...
     * @return void
     */
    public function initWomenRelatedByHusbandId(bool $overrideExisting = true): void
    {
        if (null !== $this->collWomenRelatedByHusbandId && !$overrideExisting) {
            return;
        }

        $collectionClassName = WomanTableMap::getTableMap()->getCollectionClassName();

        $this->collWomenRelatedByHusbandId = new $collectionClassName;
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildWoman> List of ChildWoman objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collWomenRelatedByHusbandId || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collWomenRelatedByHusbandId) {
                    ...
                    $collWomenRelatedByHusbandId = new $collectionClassName;
                    $collWomenRelatedByHusbandId->setModel('\Propel\Tests\Bookstore\Woman');
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countWomenRelatedByHusbandId(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collWomenRelatedByHusbandIdPartial && !$this->isNew();
        if (null === $this->collWomenRelatedByHusbandId || null !== $criteria || $partial) {
    ...
    public function addWomanRelatedByHusbandId(ChildWoman $l)
    {
        ...
        if (!$this->collWomenRelatedByHusbandId->contains($l)) {
            ...
            if ($this->womenRelatedByHusbandIdScheduledForDeletion and $this->womenRelatedByHusbandIdScheduledForDeletion->contains($l)) {
                $this->womenRelatedByHusbandIdScheduledForDeletion->remove($this->womenRelatedByHusbandIdScheduledForDeletion->search($l));
            }
        }
     ...
     */
    protected function doAddWomanRelatedByHusbandId(ChildWoman $womanRelatedByHusbandId): void
    {
