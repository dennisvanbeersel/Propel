...
abstract class Contest implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\ContestTableMap';
    ...
    public function setCountryCode($v)
    {
        ...
        if ($this->country_code !== $v) {
            $this->country_code = $v;
            $this->modifiedColumns[ContestTableMap::COL_COUNTRY_CODE] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ContestTableMap::translateFieldName('CountryCode', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ContestTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(ContestTableMap::COL_COUNTRY_CODE)) {
    ...
    {
        $pos = (int)ContestTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ContestTableMap::COL_COUNTRY_CODE)) {
            $criteria->add(ContestTableMap::COL_COUNTRY_CODE, $this->country_code);
        }
    ...
    {
        if (null !== $this->aCountry) {
            $this->aCountry->removeContest($this);
        }
        $this->id = null;
        $this->name = null;
