...
abstract class BookstoreEmployee implements ActiveRecordInterface
{
     ...
     * @var        int
     */
    public protected(set) ?int $class_key = null;
     ...
     * @var        string|null
     */
    public protected(set) ?string $job_title = null;
     ...
     * @var        int|null
     */
    public protected(set) ?int $supervisor_id = null;
    ...
    {
        $pos = (int)BookstoreEmployeeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
