...
abstract class Media implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\MediaTableMap';
     ...
     * @var        string|null
     */
    public protected(set) ?string $excerpt = null;
    ...
    {
        $pos = (int)MediaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
