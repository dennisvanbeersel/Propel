...
abstract class BookClubList implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\BookClubListTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildBook> Cross Collection to store aggregation of ChildBook objects.
     */
    protected $collBooks;
    ...
    {
        $pos = (int)BookClubListTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BookClubList'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['BookClubList'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildBookClubListQuery::create();
        $criteria->add(BookClubListTableMap::COL_ID, $this->id);
     ...
     * @return bool
     */
    public function isBooksLoaded(): bool
    {
     ...
     */
    public function countBooks(?Criteria $criteria = null, $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collBooksPartial && !$this->isNew();
        if (null === $this->collBooks || null !== $criteria || $partial) {
    ...
    /**
     * Initializes the collFavoriteBooks crossRef collection.
     *
    ...
    public function initFavoriteBooks()
    {
        ...
        $this->collFavoriteBooks = new $collectionClassName;
     ...
     * @return bool
     */
    public function isFavoriteBooksLoaded(): bool
    {
     ...
     * @return int The number of related Book objects
     */
    public function countFavoriteBooks(?Criteria $criteria = null, $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collFavoriteBooksPartial && !$this->isNew();
        if (null === $this->collFavoriteBooks || null !== $criteria || $partial) {
