...
abstract class Author implements ActiveRecordInterface
{
     ...
     * @var        string
     */
    public protected(set) ?string $first_name = null;
     ...
     * @var        string
     */
    public protected(set) ?string $last_name = null;
     ...
     * @var        int|null
     */
    public protected(set) ?int $age = null;
    ...
    {
        $pos = (int)AuthorTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
